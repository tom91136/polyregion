...
//
//    val image = Buffer.ofZeroed[Colour](width * height)(using new NativeStruct[Colour] {
//      override def name = ???
//      override def sizeInBytes = ???
//      override def encode(buffer: ByteBuffer, index: Int, a: Colour): Unit = ???
//      override def decode(buffer: ByteBuffer, index: Int) = ???
//    })
//
//    object A {
//      final val Const: Int                      = ???
