...
template <typename T> static void sym(const std::string &name, T (*f)(T)) { llvm::sys::DynamicLibrary::AddSymbol(name, (void *)f); }

template <typename T> static void sym(const std::string &name, T (*f)(T, T)) { llvm::sys::DynamicLibrary::AddSymbol(name, (void *)f); }

template <typename T> static void sym(const std::string &name, T (*f)(T, T, T)) { llvm::sys::DynamicLibrary::AddSymbol(name, (void *)f); }

template <typename T> static void sym(const std::string &name, T f) { llvm::sys::DynamicLibrary::AddSymbol(name, (void *)f); }
