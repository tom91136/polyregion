...
uint64_t __polyregion_builtin_gpu_global_idx(size_t);

template <typename F> //
const polyregion::runtime::KernelBundle &__polyregion_offload__([[maybe_unused]] F) {
  [[maybe_unused]] size_t __stub_kernelImageSize__{};
  [[maybe_unused]] const unsigned char *__stub_kernelImageBytes__{};
