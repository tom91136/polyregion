#pragma region case: capability-package
...
namespace foo {
template <class T> [[clang::annotate("polyregion_import:foo:bar.capable_increment")]] inline T increment(T x) { __builtin_trap(); }
} // namespace foo
