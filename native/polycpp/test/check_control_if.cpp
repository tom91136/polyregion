// #CASE: a<b
// #RUN: polycpp -fstdpar -fstdpar-arch=host@native -DCHECK_EXPR_DEF=a<b -o {output} {input}
...
// #CASE: a==b?false:true
// #RUN: polycpp -fstdpar -fstdpar-arch=host@native -DCHECK_EXPR_DEF=a==b?false:true -o {output} {input}
// #RUN: POLYSTL_PLATFORM=host A=1 B=2 {output}
//   #EXPECT: 42
// #RUN: POLYSTL_PLATFORM=host A=2 B=1 {output}
//   #EXPECT: 42
