...
#pragma region compile-fails: package interface compilation requires C++ exceptions for failure-safe context cleanup
...
int importRemoteIncrement() { return foo::remote_increment(41); }
