...
static void registerMethods(JNIEnv *env) {
  auto clazz = env->FindClass("polyregion/jvm/compiler/Compiler");
...
static void unregisterMethods(JNIEnv *env) { env->UnregisterNatives(env->FindClass("polyregion/jvm/compiler/Compiler")); }
} // namespace polyregion::generated::registry::Compiler