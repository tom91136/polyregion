...
# ASan instrumentation for offload-runtime debugging.
set(_ASAN_FLAGS "-fsanitize=address -fno-omit-frame-pointer -g")
set(CMAKE_C_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} ${_ASAN_FLAGS}")
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_CXX_FLAGS_INIT} ${_ASAN_FLAGS}")
set(CMAKE_ASM_FLAGS_INIT "${CMAKE_ASM_FLAGS_INIT} ${_ASAN_FLAGS}")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-fsanitize=address")
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-fsanitize=address")
