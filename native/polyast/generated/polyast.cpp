...
Sym Sym::withFqn(const std::vector<std::string> &v_) const {
  return Sym(v_);
}
POLYREGION_EXPORT bool Sym::operator!=(const Sym& rhs) const { return !(*this == rhs); }
POLYREGION_EXPORT bool Sym::operator==(const Sym& rhs) const {
  return (fqn == rhs.fqn);
}
...
Type::Struct::Struct(Sym name, std::vector<Type::Any> args) noexcept : Type::Base(TypeKind::Ref()), name(std::move(name)), args(std::move(args)) {}
...
Type::Struct Type::Struct::withName(const Sym &v_) const {
  return Type::Struct(v_, args);
}
Type::Struct Type::Struct::withArgs(const std::vector<Type::Any> &v_) const {
  return Type::Struct(name, v_);
}
POLYREGION_EXPORT bool Type::Struct::operator==(const Type::Struct& rhs) const {
  return (this->name == rhs.name) && std::equal(this->args.begin(), this->args.end(), rhs.args.begin(), [](auto &&l, auto &&r) { return l == r; });
}
...
Type::Ptr::Ptr(Type::Any comp, TypeSpace::Any space) noexcept : Type::Base(TypeKind::Ref()), comp(std::move(comp)), space(std::move(space)) {}
...
Type::Arr::Arr(Type::Any comp, int32_t length, TypeSpace::Any space) noexcept : Type::Base(TypeKind::Ref()), comp(std::move(comp)), length(length), space(std::move(space)) {}
...
namespace Type { std::ostream &operator<<(std::ostream &os, const Type::Arr &x) { return x.dump(os); } }
...
Type::Arr Type::Arr::withComp(const Type::Any &v_) const {
  return Type::Arr(v_, length, space);
}
Type::Arr Type::Arr::withLength(const int32_t &v_) const {
  return Type::Arr(comp, v_, space);
}
Type::Arr Type::Arr::withSpace(const TypeSpace::Any &v_) const {
  return Type::Arr(comp, length, v_);
}
...
Type::Var Type::Var::withName(const std::string &v_) const {
  return Type::Var(v_);
}
...
Type::Exec Type::Exec::withTpeVars(const std::vector<std::string> &v_) const {
  return Type::Exec(v_, args, rtn);
}
Type::Exec Type::Exec::withArgs(const std::vector<Type::Any> &v_) const {
  return Type::Exec(tpeVars, v_, rtn);
}
Type::Exec Type::Exec::withRtn(const Type::Any &v_) const {
  return Type::Exec(tpeVars, args, v_);
}
...
namespace PathStep { std::ostream &operator<<(std::ostream &os, const Any &x) { return x.dump(os); } }
...
namespace PathStep { std::ostream &operator<<(std::ostream &os, const PathStep::Field &x) { return x.dump(os); } }
...
PathStep::Field PathStep::Field::withName(const std::string &v_) const {
  return PathStep::Field(v_);
}
POLYREGION_EXPORT bool PathStep::Field::operator==(const PathStep::Field& rhs) const {
  return (this->name == rhs.name);
}
...
namespace PathStep { std::ostream &operator<<(std::ostream &os, const PathStep::Deref &x) { return x.dump(os); } }
std::ostream &PathStep::Deref::dump(std::ostream &os) const {
  os << "Deref(";
  os << ')';
  return os;
}
POLYREGION_EXPORT bool PathStep::Deref::operator==(const PathStep::Deref& rhs) const {
  return true;
}
...
Term::Float16Const Term::Float16Const::withValue(const float &v_) const {
  return Term::Float16Const(v_);
}
POLYREGION_EXPORT bool Term::Float16Const::operator==(const Term::Float16Const& rhs) const {
...
Term::Float32Const Term::Float32Const::withValue(const float &v_) const {
  return Term::Float32Const(v_);
}
POLYREGION_EXPORT bool Term::Float32Const::operator==(const Term::Float32Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::Float64Const Term::Float64Const::withValue(const double &v_) const {
  return Term::Float64Const(v_);
}
POLYREGION_EXPORT bool Term::Float64Const::operator==(const Term::Float64Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::IntU8Const Term::IntU8Const::withValue(const int8_t &v_) const {
  return Term::IntU8Const(v_);
}
POLYREGION_EXPORT bool Term::IntU8Const::operator==(const Term::IntU8Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::IntU16Const Term::IntU16Const::withValue(const uint16_t &v_) const {
  return Term::IntU16Const(v_);
}
POLYREGION_EXPORT bool Term::IntU16Const::operator==(const Term::IntU16Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::IntU32Const Term::IntU32Const::withValue(const int32_t &v_) const {
  return Term::IntU32Const(v_);
}
POLYREGION_EXPORT bool Term::IntU32Const::operator==(const Term::IntU32Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::IntU64Const Term::IntU64Const::withValue(const int64_t &v_) const {
  return Term::IntU64Const(v_);
}
POLYREGION_EXPORT bool Term::IntU64Const::operator==(const Term::IntU64Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::IntS8Const Term::IntS8Const::withValue(const int8_t &v_) const {
  return Term::IntS8Const(v_);
}
POLYREGION_EXPORT bool Term::IntS8Const::operator==(const Term::IntS8Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::IntS16Const Term::IntS16Const::withValue(const int16_t &v_) const {
  return Term::IntS16Const(v_);
}
POLYREGION_EXPORT bool Term::IntS16Const::operator==(const Term::IntS16Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::IntS32Const Term::IntS32Const::withValue(const int32_t &v_) const {
  return Term::IntS32Const(v_);
}
POLYREGION_EXPORT bool Term::IntS32Const::operator==(const Term::IntS32Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::IntS64Const Term::IntS64Const::withValue(const int64_t &v_) const {
  return Term::IntS64Const(v_);
}
POLYREGION_EXPORT bool Term::IntS64Const::operator==(const Term::IntS64Const& rhs) const {
  return (this->value == rhs.value);
}
...
POLYREGION_EXPORT bool Term::Unit0Const::operator==(const Term::Unit0Const& rhs) const {
  return true;
}
...
Term::Bool1Const Term::Bool1Const::withValue(const bool &v_) const {
  return Term::Bool1Const(v_);
}
POLYREGION_EXPORT bool Term::Bool1Const::operator==(const Term::Bool1Const& rhs) const {
  return (this->value == rhs.value);
}
...
Term::NullPtrConst::NullPtrConst(Type::Any comp, TypeSpace::Any space) noexcept : Term::Base(Type::Ptr(comp,space)), comp(std::move(comp)), space(std::move(space)) {}
...
namespace Term { std::ostream &operator<<(std::ostream &os, const Term::NullPtrConst &x) { return x.dump(os); } }
...
Term::NullPtrConst Term::NullPtrConst::withComp(const Type::Any &v_) const {
  return Term::NullPtrConst(v_, space);
}
Term::NullPtrConst Term::NullPtrConst::withSpace(const TypeSpace::Any &v_) const {
  return Term::NullPtrConst(comp, v_);
}
...
Term::Poison Term::Poison::withT(const Type::Any &v_) const {
  return Term::Poison(v_);
}
POLYREGION_EXPORT bool Term::Poison::operator==(const Term::Poison& rhs) const {
  return (this->t == rhs.t);
}
...
Term::Select::Select(Named root, std::vector<PathStep::Any> steps, Type::Any tpe) noexcept : Term::Base(tpe), root(std::move(root)), steps(std::move(steps)), tpe(std::move(tpe)) {}
...
Term::Select Term::Select::withRoot(const Named &v_) const {
  return Term::Select(v_, steps, tpe);
}
Term::Select Term::Select::withSteps(const std::vector<PathStep::Any> &v_) const {
  return Term::Select(root, v_, tpe);
}
Term::Select Term::Select::withTpe(const Type::Any &v_) const {
  return Term::Select(root, steps, v_);
}
POLYREGION_EXPORT bool Term::Select::operator==(const Term::Select& rhs) const {
  return (this->root == rhs.root) && std::equal(this->steps.begin(), this->steps.end(), rhs.steps.begin(), [](auto &&l, auto &&r) { return l == r; }) && (this->tpe == rhs.tpe);
}
...
Expr::Alias Expr::Alias::withRef(const Term::Any &v_) const {
  return Expr::Alias(v_);
}
POLYREGION_EXPORT bool Expr::Alias::operator==(const Expr::Alias& rhs) const {
...
Expr::Cast Expr::Cast::withFrom(const Term::Any &v_) const {
...
Expr::Index::Index(Term::Any lhs, Term::Any idx, Type::Any comp) noexcept : Expr::Base(comp), lhs(std::move(lhs)), idx(std::move(idx)), comp(std::move(comp)) {}
...
Expr::Index Expr::Index::withLhs(const Term::Any &v_) const {
  return Expr::Index(v_, idx, comp);
}
Expr::Index Expr::Index::withIdx(const Term::Any &v_) const {
...
Expr::RefTo::RefTo(Term::Any lhs, std::optional<Term::Any> idx, Type::Any comp, TypeSpace::Any space) noexcept : Expr::Base(Type::Ptr(comp,space)), lhs(std::move(lhs)), idx(std::move(idx)), comp(std::move(comp)), space(std::move(space)) {}
...
Expr::RefTo Expr::RefTo::withLhs(const Term::Any &v_) const {
  return Expr::RefTo(v_, idx, comp, space);
}
Expr::RefTo Expr::RefTo::withIdx(const std::optional<Term::Any> &v_) const {
...
Expr::Alloc::Alloc(Type::Any comp, Term::Any size, TypeSpace::Any space) noexcept : Expr::Base(Type::Ptr(comp,space)), comp(std::move(comp)), size(std::move(size)), space(std::move(space)) {}
...
Expr::Alloc Expr::Alloc::withSize(const Term::Any &v_) const {
...
Expr::Invoke::Invoke(Sym name, std::vector<Type::Any> tpeArgs, std::optional<Term::Any> receiver, std::vector<Term::Any> args, Type::Any rtn) noexcept : Expr::Base(rtn), name(std::move(name)), tpeArgs(std::move(tpeArgs)), receiver(std::move(receiver)), args(std::move(args)), rtn(std::move(rtn)) {}
...
Expr::Invoke Expr::Invoke::withName(const Sym &v_) const {
  return Expr::Invoke(v_, tpeArgs, receiver, args, rtn);
}
Expr::Invoke Expr::Invoke::withTpeArgs(const std::vector<Type::Any> &v_) const {
  return Expr::Invoke(name, v_, receiver, args, rtn);
}
Expr::Invoke Expr::Invoke::withReceiver(const std::optional<Term::Any> &v_) const {
  return Expr::Invoke(name, tpeArgs, v_, args, rtn);
}
Expr::Invoke Expr::Invoke::withArgs(const std::vector<Term::Any> &v_) const {
  return Expr::Invoke(name, tpeArgs, receiver, v_, rtn);
}
Expr::Invoke Expr::Invoke::withRtn(const Type::Any &v_) const {
  return Expr::Invoke(name, tpeArgs, receiver, args, v_);
}
POLYREGION_EXPORT bool Expr::Invoke::operator==(const Expr::Invoke& rhs) const {
  return (this->name == rhs.name) && std::equal(this->tpeArgs.begin(), this->tpeArgs.end(), rhs.tpeArgs.begin(), [](auto &&l, auto &&r) { return l == r; }) && ( (!this->receiver && !rhs.receiver) || (this->receiver && rhs.receiver && *this->receiver == *rhs.receiver) ) && std::equal(this->args.begin(), this->args.end(), rhs.args.begin(), [](auto &&l, auto &&r) { return l == r; }) && (this->rtn == rhs.rtn);
}
...
Spec::GpuGlobalIdx Spec::GpuGlobalIdx::withDim(const Term::Any &v_) const {
...
Spec::GpuGlobalSize Spec::GpuGlobalSize::withDim(const Term::Any &v_) const {
...
Spec::GpuGroupIdx Spec::GpuGroupIdx::withDim(const Term::Any &v_) const {
...
Spec::GpuGroupSize Spec::GpuGroupSize::withDim(const Term::Any &v_) const {
...
Spec::GpuLocalIdx Spec::GpuLocalIdx::withDim(const Term::Any &v_) const {
...
Spec::GpuLocalSize Spec::GpuLocalSize::withDim(const Term::Any &v_) const {
...
Intr::BNot Intr::BNot::withX(const Term::Any &v_) const {
...
Intr::LogicNot Intr::LogicNot::withX(const Term::Any &v_) const {
...
Intr::Pos Intr::Pos::withX(const Term::Any &v_) const {
...
Intr::Neg Intr::Neg::withX(const Term::Any &v_) const {
...
Intr::Add Intr::Add::withX(const Term::Any &v_) const {
  return Intr::Add(v_, y, rtn);
}
Intr::Add Intr::Add::withY(const Term::Any &v_) const {
...
Intr::Sub Intr::Sub::withX(const Term::Any &v_) const {
  return Intr::Sub(v_, y, rtn);
}
Intr::Sub Intr::Sub::withY(const Term::Any &v_) const {
...
Intr::Mul Intr::Mul::withX(const Term::Any &v_) const {
  return Intr::Mul(v_, y, rtn);
}
Intr::Mul Intr::Mul::withY(const Term::Any &v_) const {
...
Intr::Div Intr::Div::withX(const Term::Any &v_) const {
  return Intr::Div(v_, y, rtn);
}
Intr::Div Intr::Div::withY(const Term::Any &v_) const {
...
Intr::Rem Intr::Rem::withX(const Term::Any &v_) const {
  return Intr::Rem(v_, y, rtn);
}
Intr::Rem Intr::Rem::withY(const Term::Any &v_) const {
...
Intr::Min Intr::Min::withX(const Term::Any &v_) const {
  return Intr::Min(v_, y, rtn);
}
Intr::Min Intr::Min::withY(const Term::Any &v_) const {
...
Intr::Max Intr::Max::withX(const Term::Any &v_) const {
  return Intr::Max(v_, y, rtn);
}
Intr::Max Intr::Max::withY(const Term::Any &v_) const {
...
Intr::BAnd Intr::BAnd::withX(const Term::Any &v_) const {
  return Intr::BAnd(v_, y, rtn);
}
Intr::BAnd Intr::BAnd::withY(const Term::Any &v_) const {
...
Intr::BOr Intr::BOr::withX(const Term::Any &v_) const {
  return Intr::BOr(v_, y, rtn);
}
Intr::BOr Intr::BOr::withY(const Term::Any &v_) const {
...
Intr::BXor Intr::BXor::withX(const Term::Any &v_) const {
  return Intr::BXor(v_, y, rtn);
}
Intr::BXor Intr::BXor::withY(const Term::Any &v_) const {
...
Intr::BSL Intr::BSL::withX(const Term::Any &v_) const {
  return Intr::BSL(v_, y, rtn);
}
Intr::BSL Intr::BSL::withY(const Term::Any &v_) const {
...
Intr::BSR Intr::BSR::withX(const Term::Any &v_) const {
  return Intr::BSR(v_, y, rtn);
}
Intr::BSR Intr::BSR::withY(const Term::Any &v_) const {
...
Intr::BZSR Intr::BZSR::withX(const Term::Any &v_) const {
  return Intr::BZSR(v_, y, rtn);
}
Intr::BZSR Intr::BZSR::withY(const Term::Any &v_) const {
...
Intr::LogicAnd Intr::LogicAnd::withX(const Term::Any &v_) const {
  return Intr::LogicAnd(v_, y);
}
Intr::LogicAnd Intr::LogicAnd::withY(const Term::Any &v_) const {
...
Intr::LogicOr Intr::LogicOr::withX(const Term::Any &v_) const {
  return Intr::LogicOr(v_, y);
}
Intr::LogicOr Intr::LogicOr::withY(const Term::Any &v_) const {
...
Intr::LogicEq Intr::LogicEq::withX(const Term::Any &v_) const {
  return Intr::LogicEq(v_, y);
}
Intr::LogicEq Intr::LogicEq::withY(const Term::Any &v_) const {
...
Intr::LogicNeq Intr::LogicNeq::withX(const Term::Any &v_) const {
  return Intr::LogicNeq(v_, y);
}
Intr::LogicNeq Intr::LogicNeq::withY(const Term::Any &v_) const {
...
Intr::LogicLte Intr::LogicLte::withX(const Term::Any &v_) const {
  return Intr::LogicLte(v_, y);
}
Intr::LogicLte Intr::LogicLte::withY(const Term::Any &v_) const {
...
Intr::LogicGte Intr::LogicGte::withX(const Term::Any &v_) const {
  return Intr::LogicGte(v_, y);
}
Intr::LogicGte Intr::LogicGte::withY(const Term::Any &v_) const {
...
Intr::LogicLt Intr::LogicLt::withX(const Term::Any &v_) const {
  return Intr::LogicLt(v_, y);
}
Intr::LogicLt Intr::LogicLt::withY(const Term::Any &v_) const {
...
Intr::LogicGt Intr::LogicGt::withX(const Term::Any &v_) const {
  return Intr::LogicGt(v_, y);
}
Intr::LogicGt Intr::LogicGt::withY(const Term::Any &v_) const {
...
Math::Abs Math::Abs::withX(const Term::Any &v_) const {
...
Math::Sin Math::Sin::withX(const Term::Any &v_) const {
...
Math::Cos Math::Cos::withX(const Term::Any &v_) const {
...
Math::Tan Math::Tan::withX(const Term::Any &v_) const {
...
Math::Asin Math::Asin::withX(const Term::Any &v_) const {
...
Math::Acos Math::Acos::withX(const Term::Any &v_) const {
...
Math::Atan Math::Atan::withX(const Term::Any &v_) const {
...
Math::Sinh Math::Sinh::withX(const Term::Any &v_) const {
...
Math::Cosh Math::Cosh::withX(const Term::Any &v_) const {
...
Math::Tanh Math::Tanh::withX(const Term::Any &v_) const {
...
Math::Signum Math::Signum::withX(const Term::Any &v_) const {
...
Math::Round Math::Round::withX(const Term::Any &v_) const {
...
Math::Ceil Math::Ceil::withX(const Term::Any &v_) const {
...
Math::Floor Math::Floor::withX(const Term::Any &v_) const {
...
Math::Rint Math::Rint::withX(const Term::Any &v_) const {
...
Math::Sqrt Math::Sqrt::withX(const Term::Any &v_) const {
...
Math::Cbrt Math::Cbrt::withX(const Term::Any &v_) const {
...
Math::Exp Math::Exp::withX(const Term::Any &v_) const {
...
Math::Expm1 Math::Expm1::withX(const Term::Any &v_) const {
...
Math::Log Math::Log::withX(const Term::Any &v_) const {
...
Math::Log1p Math::Log1p::withX(const Term::Any &v_) const {
...
Math::Log10 Math::Log10::withX(const Term::Any &v_) const {
...
Math::Pow Math::Pow::withX(const Term::Any &v_) const {
  return Math::Pow(v_, y, rtn);
}
Math::Pow Math::Pow::withY(const Term::Any &v_) const {
...
Math::Atan2 Math::Atan2::withX(const Term::Any &v_) const {
  return Math::Atan2(v_, y, rtn);
}
Math::Atan2 Math::Atan2::withY(const Term::Any &v_) const {
...
Math::Hypot Math::Hypot::withX(const Term::Any &v_) const {
  return Math::Hypot(v_, y, rtn);
}
Math::Hypot Math::Hypot::withY(const Term::Any &v_) const {
...
Stmt::Var::Var(Named name, std::optional<Expr::Any> expr, bool isMutable) noexcept : Stmt::Base(), name(std::move(name)), expr(std::move(expr)), isMutable(isMutable) {}
...
Stmt::Var Stmt::Var::withName(const Named &v_) const {
  return Stmt::Var(v_, expr, isMutable);
}
Stmt::Var Stmt::Var::withExpr(const std::optional<Expr::Any> &v_) const {
  return Stmt::Var(name, v_, isMutable);
}
Stmt::Var Stmt::Var::withIsMutable(const bool &v_) const {
  return Stmt::Var(name, expr, v_);
}
POLYREGION_EXPORT bool Stmt::Var::operator==(const Stmt::Var& rhs) const {
  return (this->name == rhs.name) && ( (!this->expr && !rhs.expr) || (this->expr && rhs.expr && *this->expr == *rhs.expr) ) && (this->isMutable == rhs.isMutable);
}
...
Stmt::Mut Stmt::Mut::withName(const Term::Select &v_) const {
...
Stmt::Update::Update(Term::Select lhs, Term::Any idx, Term::Any value) noexcept : Stmt::Base(), lhs(std::move(lhs)), idx(std::move(idx)), value(std::move(value)) {}
...
Stmt::Update Stmt::Update::withLhs(const Term::Select &v_) const {
  return Stmt::Update(v_, idx, value);
}
Stmt::Update Stmt::Update::withIdx(const Term::Any &v_) const {
  return Stmt::Update(lhs, v_, value);
}
Stmt::Update Stmt::Update::withValue(const Term::Any &v_) const {
...
Stmt::While Stmt::While::withCond(const Term::Any &v_) const {
  return Stmt::While(v_, body);
}
Stmt::While Stmt::While::withBody(const std::vector<Stmt::Any> &v_) const {
  return Stmt::While(cond, v_);
}
POLYREGION_EXPORT bool Stmt::While::operator==(const Stmt::While& rhs) const {
  return (this->cond == rhs.cond) && std::equal(this->body.begin(), this->body.end(), rhs.body.begin(), [](auto &&l, auto &&r) { return l == r; });
}
...
Stmt::ForRange::ForRange(Named induction, Term::Any lbIncl, Term::Any ubExcl, Term::Any step, std::vector<Stmt::Any> body) noexcept : Stmt::Base(), induction(std::move(induction)), lbIncl(std::move(lbIncl)), ubExcl(std::move(ubExcl)), step(std::move(step)), body(std::move(body)) {}
...
Stmt::ForRange Stmt::ForRange::withInduction(const Named &v_) const {
  return Stmt::ForRange(v_, lbIncl, ubExcl, step, body);
}
Stmt::ForRange Stmt::ForRange::withLbIncl(const Term::Any &v_) const {
  return Stmt::ForRange(induction, v_, ubExcl, step, body);
}
Stmt::ForRange Stmt::ForRange::withUbExcl(const Term::Any &v_) const {
  return Stmt::ForRange(induction, lbIncl, v_, step, body);
}
Stmt::ForRange Stmt::ForRange::withStep(const Term::Any &v_) const {
...
Stmt::Cond::Cond(Term::Any cond, std::vector<Stmt::Any> trueBr, std::vector<Stmt::Any> falseBr) noexcept : Stmt::Base(), cond(std::move(cond)), trueBr(std::move(trueBr)), falseBr(std::move(falseBr)) {}
...
Stmt::Cond Stmt::Cond::withCond(const Term::Any &v_) const {
...
Stmt::Annotated::Annotated(Stmt::Any inner, std::optional<SourcePosition> pos, std::optional<std::string> comment) noexcept : Stmt::Base(), inner(std::move(inner)), pos(std::move(pos)), comment(std::move(comment)) {}
...
Signature Signature::withName(const Sym &v_) const {
  return Signature(v_, tpeVars, receiver, args, moduleCaptures, termCaptures, rtn);
}
...
InvokeSignature::InvokeSignature(Sym name, std::vector<Type::Any> tpeVars, std::optional<Type::Any> receiver, std::vector<Type::Any> args, Type::Any rtn) noexcept : name(std::move(name)), tpeVars(std::move(tpeVars)), receiver(std::move(receiver)), args(std::move(args)), rtn(std::move(rtn)) {}
...
InvokeSignature InvokeSignature::withName(const Sym &v_) const {
  return InvokeSignature(v_, tpeVars, receiver, args, rtn);
}
...
InvokeSignature InvokeSignature::withRtn(const Type::Any &v_) const {
  return InvokeSignature(name, tpeVars, receiver, args, v_);
}
...
POLYREGION_EXPORT bool InvokeSignature::operator==(const InvokeSignature& rhs) const {
  return (name == rhs.name) && std::equal(tpeVars.begin(), tpeVars.end(), rhs.tpeVars.begin(), [](auto &&l, auto &&r) { return l == r; }) && ( (!receiver && !rhs.receiver) || (receiver && rhs.receiver && *receiver == *rhs.receiver) ) && std::equal(args.begin(), args.end(), rhs.args.begin(), [](auto &&l, auto &&r) { return l == r; }) && (rtn == rhs.rtn);
}
...
namespace FunctionVisibility { std::ostream &operator<<(std::ostream &os, const Any &x) { return x.dump(os); } }
...
namespace FunctionVisibility { std::ostream &operator<<(std::ostream &os, const FunctionVisibility::Internal &x) { return x.dump(os); } }
std::ostream &FunctionVisibility::Internal::dump(std::ostream &os) const {
  os << "Internal(";
  os << ')';
  return os;
}
POLYREGION_EXPORT bool FunctionVisibility::Internal::operator==(const FunctionVisibility::Internal& rhs) const {
  return true;
}
...
FunctionVisibility::Internal::operator FunctionVisibility::Any() const { return std::static_pointer_cast<Base>(std::make_shared<Internal>(*this)); }
...
namespace FunctionVisibility { std::ostream &operator<<(std::ostream &os, const FunctionVisibility::Exported &x) { return x.dump(os); } }
std::ostream &FunctionVisibility::Exported::dump(std::ostream &os) const {
  os << "Exported(";
  os << ')';
  return os;
}
POLYREGION_EXPORT bool FunctionVisibility::Exported::operator==(const FunctionVisibility::Exported& rhs) const {
  return true;
}
...
FunctionVisibility::Exported::operator FunctionVisibility::Any() const { return std::static_pointer_cast<Base>(std::make_shared<Exported>(*this)); }
...
namespace FunctionFpMode { std::ostream &operator<<(std::ostream &os, const Any &x) { return x.dump(os); } }
...
namespace FunctionFpMode { std::ostream &operator<<(std::ostream &os, const FunctionFpMode::Relaxed &x) { return x.dump(os); } }
std::ostream &FunctionFpMode::Relaxed::dump(std::ostream &os) const {
  os << "Relaxed(";
  os << ')';
  return os;
}
POLYREGION_EXPORT bool FunctionFpMode::Relaxed::operator==(const FunctionFpMode::Relaxed& rhs) const {
  return true;
}
...
namespace FunctionFpMode { std::ostream &operator<<(std::ostream &os, const FunctionFpMode::Strict &x) { return x.dump(os); } }
std::ostream &FunctionFpMode::Strict::dump(std::ostream &os) const {
  os << "Strict(";
  os << ')';
  return os;
}
POLYREGION_EXPORT bool FunctionFpMode::Strict::operator==(const FunctionFpMode::Strict& rhs) const {
  return true;
}
...
Function::Function(Sym name, std::vector<std::string> tpeVars, std::optional<Arg> receiver, std::vector<Arg> args, std::vector<Arg> moduleCaptures, std::vector<Arg> termCaptures, Type::Any rtn, std::vector<Stmt::Any> body, FunctionVisibility::Any visibility, FunctionFpMode::Any fpMode, bool isEntry) noexcept : name(std::move(name)), tpeVars(std::move(tpeVars)), receiver(std::move(receiver)), args(std::move(args)), moduleCaptures(std::move(moduleCaptures)), termCaptures(std::move(termCaptures)), rtn(std::move(rtn)), body(std::move(body)), visibility(std::move(visibility)), fpMode(std::move(fpMode)), isEntry(isEntry) {}
...
POLYREGION_EXPORT bool Function::operator==(const Function& rhs) const {
  return (name == rhs.name) && (tpeVars == rhs.tpeVars) && (receiver == rhs.receiver) && (args == rhs.args) && (moduleCaptures == rhs.moduleCaptures) && (termCaptures == rhs.termCaptures) && (rtn == rhs.rtn) && std::equal(body.begin(), body.end(), rhs.body.begin(), [](auto &&l, auto &&r) { return l == r; }) && (visibility == rhs.visibility) && (fpMode == rhs.fpMode) && (isEntry == rhs.isEntry);
}

StructDef::StructDef(Sym name, std::vector<std::string> tpeVars, std::vector<Named> members, std::vector<Type::Struct> parents) noexcept : name(std::move(name)), tpeVars(std::move(tpeVars)), members(std::move(members)), parents(std::move(parents)) {}
...
StructDef StructDef::withName(const Sym &v_) const {
  return StructDef(v_, tpeVars, members, parents);
}
StructDef StructDef::withTpeVars(const std::vector<std::string> &v_) const {
  return StructDef(name, v_, members, parents);
}
StructDef StructDef::withMembers(const std::vector<Named> &v_) const {
  return StructDef(name, tpeVars, v_, parents);
}
StructDef StructDef::withParents(const std::vector<Type::Struct> &v_) const {
  return StructDef(name, tpeVars, members, v_);
}
...
Mirror::Mirror(Sym source, std::vector<Sym> sourceParents, StructDef structDef, std::vector<Function> functions, std::vector<StructDef> dependencies) noexcept : source(std::move(source)), sourceParents(std::move(sourceParents)), structDef(std::move(structDef)), functions(std::move(functions)), dependencies(std::move(dependencies)) {}
...
Mirror Mirror::withSource(const Sym &v_) const {
  return Mirror(v_, sourceParents, structDef, functions, dependencies);
}
Mirror Mirror::withSourceParents(const std::vector<Sym> &v_) const {
  return Mirror(source, v_, structDef, functions, dependencies);
}
Mirror Mirror::withStructDef(const StructDef &v_) const {
  return Mirror(source, sourceParents, v_, functions, dependencies);
}
Mirror Mirror::withFunctions(const std::vector<Function> &v_) const {
  return Mirror(source, sourceParents, structDef, v_, dependencies);
}
Mirror Mirror::withDependencies(const std::vector<StructDef> &v_) const {
  return Mirror(source, sourceParents, structDef, functions, v_);
}
...
POLYREGION_EXPORT bool Mirror::operator==(const Mirror& rhs) const {
  return (source == rhs.source) && (sourceParents == rhs.sourceParents) && (structDef == rhs.structDef) && (functions == rhs.functions) && (dependencies == rhs.dependencies);
}
...
namespace PassPhase { std::ostream &operator<<(std::ostream &os, const Any &x) { return x.dump(os); } }
...
namespace PassPhase { std::ostream &operator<<(std::ostream &os, const PassPhase::Initial &x) { return x.dump(os); } }
std::ostream &PassPhase::Initial::dump(std::ostream &os) const {
  os << "Initial(";
  os << ')';
  return os;
}
POLYREGION_EXPORT bool PassPhase::Initial::operator==(const PassPhase::Initial& rhs) const {
  return true;
}
...
namespace PassPhase { std::ostream &operator<<(std::ostream &os, const PassPhase::PostMono &x) { return x.dump(os); } }
std::ostream &PassPhase::PostMono::dump(std::ostream &os) const {
  os << "PostMono(";
  os << ')';
  return os;
}
POLYREGION_EXPORT bool PassPhase::PostMono::operator==(const PassPhase::PostMono& rhs) const {
  return true;
}
...
Program::Program(Function entry, std::vector<Function> functions, std::vector<StructDef> defs, PassPhase::Any phase) noexcept : entry(std::move(entry)), functions(std::move(functions)), defs(std::move(defs)), phase(std::move(phase)) {}
...
Program Program::withEntry(const Function &v_) const {
  return Program(v_, functions, defs, phase);
}
Program Program::withFunctions(const std::vector<Function> &v_) const {
  return Program(entry, v_, defs, phase);
}
Program Program::withDefs(const std::vector<StructDef> &v_) const {
  return Program(entry, functions, v_, phase);
}
Program Program::withPhase(const PassPhase::Any &v_) const {
  return Program(entry, functions, defs, v_);
}
...
std::size_t std::hash<polyregion::polyast::Type::Arr>::operator()(const polyregion::polyast::Type::Arr &x) const noexcept { return x.hash_code(); }
...
std::size_t std::hash<polyregion::polyast::PathStep::Any>::operator()(const polyregion::polyast::PathStep::Any &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::PathStep::Field>::operator()(const polyregion::polyast::PathStep::Field &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::PathStep::Deref>::operator()(const polyregion::polyast::PathStep::Deref &x) const noexcept { return x.hash_code(); }
...
std::size_t std::hash<polyregion::polyast::Term::NullPtrConst>::operator()(const polyregion::polyast::Term::NullPtrConst &x) const noexcept { return x.hash_code(); }
...
std::size_t std::hash<polyregion::polyast::FunctionVisibility::Any>::operator()(const polyregion::polyast::FunctionVisibility::Any &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::FunctionVisibility::Internal>::operator()(const polyregion::polyast::FunctionVisibility::Internal &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::FunctionVisibility::Exported>::operator()(const polyregion::polyast::FunctionVisibility::Exported &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::FunctionFpMode::Any>::operator()(const polyregion::polyast::FunctionFpMode::Any &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::FunctionFpMode::Relaxed>::operator()(const polyregion::polyast::FunctionFpMode::Relaxed &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::FunctionFpMode::Strict>::operator()(const polyregion::polyast::FunctionFpMode::Strict &x) const noexcept { return x.hash_code(); }
...
std::size_t std::hash<polyregion::polyast::Mirror>::operator()(const polyregion::polyast::Mirror &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::PassPhase::Any>::operator()(const polyregion::polyast::PassPhase::Any &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::PassPhase::Initial>::operator()(const polyregion::polyast::PassPhase::Initial &x) const noexcept { return x.hash_code(); }
std::size_t std::hash<polyregion::polyast::PassPhase::PostMono>::operator()(const polyregion::polyast::PassPhase::PostMono &x) const noexcept { return x.hash_code(); }
