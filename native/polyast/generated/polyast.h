...
struct Interface;
struct Package;
struct PackageTypeSize;
struct PackageLinkRequest;
struct PackageSymRequest;
...
struct POLYREGION_EXPORT Origin {
  std::optional<SourcePosition> pos;
  std::optional<std::string> source;
  std::optional<Sym> inlinedFrom;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT Origin withPos(const std::optional<SourcePosition> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Origin withSource(const std::optional<std::string> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Origin withInlinedFrom(const std::optional<Sym> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Origin>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    ...
    if (inlinedFrom) {
      (*inlinedFrom).collect_where<T, U>(results_, f);
    }
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Origin modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Origin>) {
      return f(*this);
    }
    ...
    std::optional<Sym> inlinedFrom__;
    if (inlinedFrom) {
      inlinedFrom__ = (*inlinedFrom).modify_all<T>(f);
    }
    return Origin(pos__, source, inlinedFrom__);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const Origin &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Origin &) const;
  Origin(std::optional<SourcePosition> pos = {}, std::optional<std::string> source = {}, std::optional<Sym> inlinedFrom = {}) noexcept;
};
...
struct POLYREGION_EXPORT Named {
  ...
  [[nodiscard]] POLYREGION_EXPORT Named withOrigin(const Origin &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    ...
    origin.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
    std::vector<U> results_;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Named modify_all(const std::function<T(const T &)> &f) const {
    ...
    return Named(symbol, tpe.modify_all<T>(f), origin.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const Named &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Named &) const;
  Named(std::string symbol, Type::Any tpe, Origin origin = {}) noexcept;
};
...
struct POLYREGION_EXPORT Constant : TypeSpace::Base {
  constexpr static uint32_t variant_id = 3;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Constant modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Constant>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const TypeSpace::Constant &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const TypeSpace::Constant &) const;
  Constant() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Var : Type::Base {
  ...
  [[nodiscard]] POLYREGION_EXPORT Type::Var withExactSizeInBytes(const std::optional<int32_t> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Var modify_all(const std::function<T(const T &)> &f) const {
    ...
    return Type::Var(name, exactSizeInBytes);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Type::Var &) const;
  Var(std::string name, std::optional<int32_t> exactSizeInBytes = {}) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
...
struct POLYREGION_EXPORT Exec : Type::Base {
  ...
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Type::Exec withTpeVars(const std::vector<Type::Var> &v_) const;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Exec modify_all(const std::function<T(const T &)> &f) const {
    ...
    return Type::Exec(tpeVars__, args__, rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Type::Exec &) const;
  Exec(std::vector<Type::Var> tpeVars, std::vector<Type::Any> args, Type::Any rtn) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT FnRef : Type::Base {
  Sym name;
  constexpr static uint32_t variant_id = 19;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Type::FnRef withName(const Sym &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, FnRef>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT FnRef modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, FnRef>) {
      return f(*this);
    }
    return Type::FnRef(name.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Type::FnRef &) const;
  explicit FnRef(Sym name) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace Type
...
struct POLYREGION_EXPORT Index : PathStep::Base {
  int32_t idx;
  constexpr static uint32_t variant_id = 2;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT PathStep::Index withIdx(const int32_t &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PathStep::Index &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const PathStep::Index &) const;
  explicit Index(int32_t idx) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT IndexDyn : PathStep::Base {
  Term::Any idx;
  constexpr static uint32_t variant_id = 3;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT PathStep::IndexDyn withIdx(const Term::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, IndexDyn>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT IndexDyn modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, IndexDyn>) {
      return f(*this);
    }
    return PathStep::IndexDyn(idx.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PathStep::IndexDyn &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const PathStep::IndexDyn &) const;
  explicit IndexDyn(Term::Any idx) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace PathStep
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const Region::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const Region::Base &) const = 0;
...
struct POLYREGION_EXPORT Rooted : Region::Base {
  Named root;
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Region::Rooted withRoot(const Named &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Rooted>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Rooted modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Rooted>) {
      return f(*this);
    }
    return Region::Rooted(root.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Region::Rooted &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Region::Rooted &) const;
  explicit Rooted(Named root) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT Opaque : Region::Base {
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Opaque modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Opaque>) {
      return f(*this);
    }
    return Region::Opaque();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Region::Opaque &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Region::Opaque &) const;
  Opaque() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT NullPtrConst : Term::Base {
  ...
  [[nodiscard]] POLYREGION_EXPORT Term::NullPtrConst withRegion(const Region::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    ...
    comp.collect_where<T, U>(results_, f);
    space.collect_where<T, U>(results_, f);
    region.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
    std::vector<U> results_;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT NullPtrConst modify_all(const std::function<T(const T &)> &f) const {
    ...
    return Term::NullPtrConst(comp.modify_all<T>(f), space.modify_all<T>(f), region.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Term::NullPtrConst &) const;
  NullPtrConst(Type::Any comp, TypeSpace::Any space, Region::Any region) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
...
struct POLYREGION_EXPORT RefTo : Expr::Base {
  ...
  [[nodiscard]] POLYREGION_EXPORT Expr::RefTo withRegion(const Region::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT RefTo modify_all(const std::function<T(const T &)> &f) const {
    ...
    return Expr::RefTo(lhs.modify_all<T>(f), idx__, comp.modify_all<T>(f), space.modify_all<T>(f), region.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Expr::RefTo &) const;
  RefTo(Term::Any lhs, std::optional<Term::Any> idx, Type::Any comp, TypeSpace::Any space, Region::Any region) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
...
struct POLYREGION_EXPORT Alloc : Expr::Base {
  ...
  [[nodiscard]] POLYREGION_EXPORT Expr::Alloc withRegion(const Region::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Alloc modify_all(const std::function<T(const T &)> &f) const {
    ...
    return Expr::Alloc(comp.modify_all<T>(f), size.modify_all<T>(f), space.modify_all<T>(f), region.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Expr::Alloc &) const;
  Alloc(Type::Any comp, Term::Any size, TypeSpace::Any space, Region::Any region) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
...
struct POLYREGION_EXPORT Invoke : Expr::Base {
  ...
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Expr::Invoke withCallee(const Type::Any &v_) const;
  ...
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    ...
    callee.collect_where<T, U>(results_, f);
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Invoke modify_all(const std::function<T(const T &)> &f) const {
    ...
    return Expr::Invoke(callee.modify_all<T>(f), tpeArgs__, receiver__, args__, rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Expr::Invoke &) const;
  Invoke(Type::Any callee, std::vector<Type::Any> tpeArgs, std::optional<Term::Any> receiver, std::vector<Term::Any> args,
         Type::Any rtn) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT ForeignCall : Expr::Base {
  std::string name;
  std::vector<Term::Any> args;
  Type::Any rtn;
  constexpr static uint32_t variant_id = 9;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Expr::ForeignCall withName(const std::string &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Expr::ForeignCall withArgs(const std::vector<Term::Any> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Expr::ForeignCall withRtn(const Type::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ForeignCall>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT ForeignCall modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ForeignCall>) {
      return f(*this);
    }
    std::vector<Term::Any> args__;
    ...
    return Expr::ForeignCall(name, args__, rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Expr::ForeignCall &) const;
  ForeignCall(std::string name, std::vector<Term::Any> args, Type::Any rtn) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT OffsetOf : Expr::Base {
  Type::Any structTpe;
  std::string field;
  constexpr static uint32_t variant_id = 10;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Expr::OffsetOf withStructTpe(const Type::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Expr::OffsetOf withField(const std::string &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, OffsetOf>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    structTpe.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
    std::vector<U> results_;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT OffsetOf modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, OffsetOf>) {
      return f(*this);
    }
    return Expr::OffsetOf(structTpe.modify_all<T>(f), field);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Expr::OffsetOf &) const;
  OffsetOf(Type::Any structTpe, std::string field) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT SizeOf : Expr::Base {
  Type::Any forTpe;
  constexpr static uint32_t variant_id = 11;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Expr::SizeOf withForTpe(const Type::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, SizeOf>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    forTpe.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
    std::vector<U> results_;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT SizeOf modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, SizeOf>) {
      return f(*this);
    }
    return Expr::SizeOf(forTpe.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Expr::SizeOf &) const;
  explicit SizeOf(Type::Any forTpe) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace Expr
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const AtomicOp::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const AtomicOp::Base &) const = 0;
...
struct POLYREGION_EXPORT Xchg : AtomicOp::Base {
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Xchg>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Xchg modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Xchg>) {
      return f(*this);
    }
    return AtomicOp::Xchg();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const AtomicOp::Xchg &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const AtomicOp::Xchg &) const;
  Xchg() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Add : AtomicOp::Base {
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const AtomicOp::Add &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const AtomicOp::Add &) const;
  Add() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Sub : AtomicOp::Base {
  constexpr static uint32_t variant_id = 2;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const AtomicOp::Sub &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const AtomicOp::Sub &) const;
  Sub() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT And : AtomicOp::Base {
  constexpr static uint32_t variant_id = 3;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, And>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT And modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, And>) {
      return f(*this);
    }
    return AtomicOp::And();
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const AtomicOp::And &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const AtomicOp::And &) const;
  And() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Or : AtomicOp::Base {
  constexpr static uint32_t variant_id = 4;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Or modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Or>) {
      return f(*this);
    }
    return AtomicOp::Or();
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const AtomicOp::Or &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const AtomicOp::Or &) const;
  Or() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Xor : AtomicOp::Base {
  constexpr static uint32_t variant_id = 5;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Xor>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Xor modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Xor>) {
      return f(*this);
    }
    return AtomicOp::Xor();
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const AtomicOp::Xor &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const AtomicOp::Xor &) const;
  Xor() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Min : AtomicOp::Base {
  constexpr static uint32_t variant_id = 6;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const AtomicOp::Min &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const AtomicOp::Min &) const;
  Min() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Max : AtomicOp::Base {
  constexpr static uint32_t variant_id = 7;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const AtomicOp::Max &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const AtomicOp::Max &) const;
  Max() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const MemScope::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const MemScope::Base &) const = 0;
...
struct POLYREGION_EXPORT Subgroup : MemScope::Base {
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Subgroup>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Subgroup modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Subgroup>) {
      return f(*this);
    }
    return MemScope::Subgroup();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const MemScope::Subgroup &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const MemScope::Subgroup &) const;
  Subgroup() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Workgroup : MemScope::Base {
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Workgroup>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Workgroup modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Workgroup>) {
      return f(*this);
    }
    return MemScope::Workgroup();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const MemScope::Workgroup &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const MemScope::Workgroup &) const;
  Workgroup() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Device : MemScope::Base {
  constexpr static uint32_t variant_id = 2;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Device modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Device>) {
      return f(*this);
    }
    return MemScope::Device();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const MemScope::Device &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const MemScope::Device &) const;
  Device() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT System : MemScope::Base {
  constexpr static uint32_t variant_id = 3;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT System modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, System>) {
      return f(*this);
    }
    return MemScope::System();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const MemScope::System &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const MemScope::System &) const;
  System() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const MemOrder::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const MemOrder::Base &) const = 0;
...
struct POLYREGION_EXPORT Relaxed : MemOrder::Base {
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const MemOrder::Relaxed &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const MemOrder::Relaxed &) const;
  Relaxed() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Acquire : MemOrder::Base {
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Acquire modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Acquire>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const MemOrder::Acquire &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const MemOrder::Acquire &) const;
  Acquire() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Release : MemOrder::Base {
  constexpr static uint32_t variant_id = 2;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Release>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Release modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Release>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const MemOrder::Release &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const MemOrder::Release &) const;
  Release() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT AcqRel : MemOrder::Base {
  constexpr static uint32_t variant_id = 3;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, AcqRel>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT AcqRel modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, AcqRel>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const MemOrder::AcqRel &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const MemOrder::AcqRel &) const;
  AcqRel() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT SeqCst : MemOrder::Base {
  constexpr static uint32_t variant_id = 4;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, SeqCst>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT SeqCst modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, SeqCst>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const MemOrder::SeqCst &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const MemOrder::SeqCst &) const;
  SeqCst() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const Direction::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const Direction::Base &) const = 0;
...
struct POLYREGION_EXPORT LocalToRemote : Direction::Base {
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, LocalToRemote>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT LocalToRemote modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, LocalToRemote>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Direction::LocalToRemote &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Direction::LocalToRemote &) const;
  LocalToRemote() noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT RemoteToLocal : Direction::Base {
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteToLocal>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT RemoteToLocal modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteToLocal>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Direction::RemoteToLocal &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Direction::RemoteToLocal &) const;
  RemoteToLocal() noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT RemoteToRemote : Direction::Base {
  constexpr static uint32_t variant_id = 2;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteToRemote>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT RemoteToRemote modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteToRemote>) {
      return f(*this);
    }
    return Direction::RemoteToRemote();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Direction::RemoteToRemote &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Direction::RemoteToRemote &) const;
  RemoteToRemote() noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace Direction
...
struct POLYREGION_EXPORT GpuAtomicRMW : Spec::Base {
  AtomicOp::Any op;
  Term::Any ptr;
  Term::Any value;
  MemScope::Any scope;
  ...
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicRMW withOp(const AtomicOp::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicRMW withPtr(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicRMW withValue(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicRMW withScope(const MemScope::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicRMW withOrder(const MemOrder::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicRMW withRtn(const Type::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuAtomicRMW>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    op.collect_where<T, U>(results_, f);
    ptr.collect_where<T, U>(results_, f);
    value.collect_where<T, U>(results_, f);
    scope.collect_where<T, U>(results_, f);
    order.collect_where<T, U>(results_, f);
    rtn.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT GpuAtomicRMW modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuAtomicRMW>) {
      return f(*this);
    }
    return Spec::GpuAtomicRMW(op.modify_all<T>(f), ptr.modify_all<T>(f), value.modify_all<T>(f), scope.modify_all<T>(f),
                              order.modify_all<T>(f), rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::GpuAtomicRMW &) const;
  GpuAtomicRMW(AtomicOp::Any op, Term::Any ptr, Term::Any value, MemScope::Any scope, MemOrder::Any order, Type::Any rtn) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT GpuAtomicCAS : Spec::Base {
  Term::Any ptr;
  Term::Any expected;
  Term::Any desired;
  MemScope::Any scope;
  ...
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicCAS withPtr(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicCAS withExpected(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicCAS withDesired(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicCAS withScope(const MemScope::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicCAS withOrder(const MemOrder::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuAtomicCAS withRtn(const Type::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuAtomicCAS>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    ptr.collect_where<T, U>(results_, f);
    expected.collect_where<T, U>(results_, f);
    desired.collect_where<T, U>(results_, f);
    scope.collect_where<T, U>(results_, f);
    order.collect_where<T, U>(results_, f);
    rtn.collect_where<T, U>(results_, f);
  }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT GpuAtomicCAS modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuAtomicCAS>) {
      return f(*this);
    }
    return Spec::GpuAtomicCAS(ptr.modify_all<T>(f), expected.modify_all<T>(f), desired.modify_all<T>(f), scope.modify_all<T>(f),
                              order.modify_all<T>(f), rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::GpuAtomicCAS &) const;
  GpuAtomicCAS(Term::Any ptr, Term::Any expected, Term::Any desired, MemScope::Any scope, MemOrder::Any order, Type::Any rtn) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT GpuGroupReduce : Spec::Base {
  AtomicOp::Any op;
  Term::Any value;
  Type::Any rtn;
  ...
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuGroupReduce withOp(const AtomicOp::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuGroupReduce withValue(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuGroupReduce withRtn(const Type::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuGroupReduce>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT GpuGroupReduce modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuGroupReduce>) {
      return f(*this);
    }
    return Spec::GpuGroupReduce(op.modify_all<T>(f), value.modify_all<T>(f), rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::GpuGroupReduce &) const;
  GpuGroupReduce(AtomicOp::Any op, Term::Any value, Type::Any rtn) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT GpuGroupInclusiveScan : Spec::Base {
  AtomicOp::Any op;
  Term::Any value;
  Type::Any rtn;
  constexpr static uint32_t variant_id = 26;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuGroupInclusiveScan withOp(const AtomicOp::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuGroupInclusiveScan withValue(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuGroupInclusiveScan withRtn(const Type::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuGroupInclusiveScan>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT GpuGroupInclusiveScan modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuGroupInclusiveScan>) {
      return f(*this);
    }
    return Spec::GpuGroupInclusiveScan(op.modify_all<T>(f), value.modify_all<T>(f), rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::GpuGroupInclusiveScan &) const;
  GpuGroupInclusiveScan(AtomicOp::Any op, Term::Any value, Type::Any rtn) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT GpuGroupExclusiveScan : Spec::Base {
  AtomicOp::Any op;
  Term::Any value;
  Type::Any rtn;
  constexpr static uint32_t variant_id = 27;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuGroupExclusiveScan withOp(const AtomicOp::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuGroupExclusiveScan withValue(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuGroupExclusiveScan withRtn(const Type::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuGroupExclusiveScan>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT GpuGroupExclusiveScan modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuGroupExclusiveScan>) {
      return f(*this);
    }
    return Spec::GpuGroupExclusiveScan(op.modify_all<T>(f), value.modify_all<T>(f), rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::GpuGroupExclusiveScan &) const;
  GpuGroupExclusiveScan(AtomicOp::Any op, Term::Any value, Type::Any rtn) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT GpuVolatileLoad : Spec::Base {
  Term::Any ptr;
  Type::Any rtn;
  constexpr static uint32_t variant_id = 28;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuVolatileLoad withPtr(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuVolatileLoad withRtn(const Type::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuVolatileLoad>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT GpuVolatileLoad modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuVolatileLoad>) {
      return f(*this);
    }
    return Spec::GpuVolatileLoad(ptr.modify_all<T>(f), rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::GpuVolatileLoad &) const;
  GpuVolatileLoad(Term::Any ptr, Type::Any rtn) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT GpuVolatileStore : Spec::Base {
  Term::Any ptr;
  Term::Any value;
  constexpr static uint32_t variant_id = 29;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuVolatileStore withPtr(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::GpuVolatileStore withValue(const Term::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuVolatileStore>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT GpuVolatileStore modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, GpuVolatileStore>) {
      return f(*this);
    }
    return Spec::GpuVolatileStore(ptr.modify_all<T>(f), value.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::GpuVolatileStore &) const;
  GpuVolatileStore(Term::Any ptr, Term::Any value) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT RemoteLaunch : Spec::Base {
  Term::Any context;
  Term::Any kernel;
  std::vector<Type::Any> tpeArgs;
  Term::Any gridX;
  ...
  Term::Any shmem;
  std::vector<Term::Any> args;
  constexpr static uint32_t variant_id = 30;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withContext(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withKernel(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withTpeArgs(const std::vector<Type::Any> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withGridX(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withGridY(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withGridZ(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withBlockX(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withBlockY(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withBlockZ(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withShmem(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteLaunch withArgs(const std::vector<Term::Any> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteLaunch>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    context.collect_where<T, U>(results_, f);
    kernel.collect_where<T, U>(results_, f);
    for (auto it = tpeArgs.begin(); it != tpeArgs.end(); ++it) {
      (*it).collect_where<T, U>(results_, f);
    }
    gridX.collect_where<T, U>(results_, f);
    gridY.collect_where<T, U>(results_, f);
    gridZ.collect_where<T, U>(results_, f);
    blockX.collect_where<T, U>(results_, f);
    blockY.collect_where<T, U>(results_, f);
    blockZ.collect_where<T, U>(results_, f);
    shmem.collect_where<T, U>(results_, f);
    for (auto it = args.begin(); it != args.end(); ++it) {
      (*it).collect_where<T, U>(results_, f);
    }
  }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT RemoteLaunch modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteLaunch>) {
      return f(*this);
    }
    std::vector<Type::Any> tpeArgs__;
    ...
    return Spec::RemoteLaunch(context.modify_all<T>(f), kernel.modify_all<T>(f), tpeArgs__, gridX.modify_all<T>(f), gridY.modify_all<T>(f),
                              gridZ.modify_all<T>(f), blockX.modify_all<T>(f), blockY.modify_all<T>(f), blockZ.modify_all<T>(f),
                              shmem.modify_all<T>(f), args__);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::RemoteLaunch &) const;
  RemoteLaunch(Term::Any context, Term::Any kernel, std::vector<Type::Any> tpeArgs, Term::Any gridX, Term::Any gridY, Term::Any gridZ,
               Term::Any blockX, Term::Any blockY, Term::Any blockZ, Term::Any shmem, std::vector<Term::Any> args = {}) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT RemoteAlloc : Spec::Base {
  Term::Any context;
  Term::Any bytes;
  constexpr static uint32_t variant_id = 31;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteAlloc withContext(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteAlloc withBytes(const Term::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteAlloc>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT RemoteAlloc modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteAlloc>) {
      return f(*this);
    }
    return Spec::RemoteAlloc(context.modify_all<T>(f), bytes.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::RemoteAlloc &) const;
  RemoteAlloc(Term::Any context, Term::Any bytes) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
...
struct POLYREGION_EXPORT RemoteFree : Spec::Base {
  ...
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteFree withPtr(const Term::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteFree>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT RemoteFree modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteFree>) {
      return f(*this);
    }
    return Spec::RemoteFree(context.modify_all<T>(f), ptr.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::RemoteFree &) const;
  RemoteFree(Term::Any context, Term::Any ptr) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT RemoteMemcpy : Spec::Base {
  Term::Any context;
  Term::Any dst;
  Term::Any src;
  Term::Any bytes;
  ...
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteMemcpy withDst(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteMemcpy withSrc(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteMemcpy withBytes(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Spec::RemoteMemcpy withDirection(const Direction::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteMemcpy>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    context.collect_where<T, U>(results_, f);
    dst.collect_where<T, U>(results_, f);
    src.collect_where<T, U>(results_, f);
    bytes.collect_where<T, U>(results_, f);
    direction.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
    std::vector<U> results_;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT RemoteMemcpy modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteMemcpy>) {
      return f(*this);
    }
    return Spec::RemoteMemcpy(context.modify_all<T>(f), dst.modify_all<T>(f), src.modify_all<T>(f), bytes.modify_all<T>(f),
                              direction.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::RemoteMemcpy &) const;
  RemoteMemcpy(Term::Any context, Term::Any dst, Term::Any src, Term::Any bytes, Direction::Any direction) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
...
struct POLYREGION_EXPORT RemoteSync : Spec::Base {
  ...
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteSync>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT RemoteSync modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RemoteSync>) {
      return f(*this);
    }
    return Spec::RemoteSync(context.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Spec::RemoteSync &) const;
  explicit RemoteSync(Term::Any context) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace Spec
...
struct POLYREGION_EXPORT ExceptionKind {
  Type::Any tpe;
  std::string sourceName;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT ExceptionKind withTpe(const Type::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT ExceptionKind withSourceName(const std::string &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ExceptionKind>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT ExceptionKind modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ExceptionKind>) {
      return f(*this);
    }
    return ExceptionKind(tpe.modify_all<T>(f), sourceName);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const ExceptionKind &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ExceptionKind &) const;
  ExceptionKind(Type::Any tpe, std::string sourceName) noexcept;
};

struct POLYREGION_EXPORT Handler {
  std::optional<ExceptionKind> caught;
  std::optional<Named> binder;
  std::vector<Stmt::Any> body;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT Handler withCaught(const std::optional<ExceptionKind> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Handler withBinder(const std::optional<Named> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Handler withBody(const std::vector<Stmt::Any> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    ...
    if (caught) {
      (*caught).collect_where<T, U>(results_, f);
    }
    if (binder) {
      (*binder).collect_where<T, U>(results_, f);
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Handler modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Handler>) {
      return f(*this);
    }
    std::optional<ExceptionKind> caught__;
    if (caught) {
      caught__ = (*caught).modify_all<T>(f);
    }
    std::optional<Named> binder__;
    if (binder) {
      binder__ = (*binder).modify_all<T>(f);
    }
    std::vector<Stmt::Any> body__;
    for (auto it = body.begin(); it != body.end(); ++it) {
      body__.emplace_back((*it).modify_all<T>(f));
    }
    return Handler(caught__, binder__, body__);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const Handler &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Handler &) const;
  Handler(std::optional<ExceptionKind> caught = {}, std::optional<Named> binder = {}, std::vector<Stmt::Any> body = {}) noexcept;
};
...
struct POLYREGION_EXPORT Try : Stmt::Base {
  std::vector<Stmt::Any> body;
  ...
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Stmt::Try withBody(const std::vector<Stmt::Any> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Stmt::Try withHandlers(const std::vector<Handler> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Stmt::Try withFin(const std::vector<Stmt::Any> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Try>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Try modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Try>) {
      return f(*this);
    }
    std::vector<Stmt::Any> body__;
    ...
    std::vector<Handler> handlers__;
    for (auto it = handlers.begin(); it != handlers.end(); ++it) {
      handlers__.emplace_back((*it).modify_all<T>(f));
    }
    std::vector<Stmt::Any> fin__;
    for (auto it = fin.begin(); it != fin.end(); ++it) {
      fin__.emplace_back((*it).modify_all<T>(f));
    }
    return Stmt::Try(body__, handlers__, fin__);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Stmt::Try &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Stmt::Try &) const;
  Try(std::vector<Stmt::Any> body = {}, std::vector<Handler> handlers = {}, std::vector<Stmt::Any> fin = {}) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT Raise : Stmt::Base {
  Term::Any value;
  ...
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT Stmt::Raise withValue(const Term::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Stmt::Raise withExceptionKind(const ExceptionKind &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Stmt::Raise withCleanup(const std::vector<Stmt::Any> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Raise>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    value.collect_where<T, U>(results_, f);
    exceptionKind.collect_where<T, U>(results_, f);
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Raise modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Raise>) {
      return f(*this);
    }
    std::vector<Stmt::Any> cleanup__;
    for (auto it = cleanup.begin(); it != cleanup.end(); ++it) {
      cleanup__.emplace_back((*it).modify_all<T>(f));
    }
    return Stmt::Raise(value.modify_all<T>(f), exceptionKind.modify_all<T>(f), cleanup__);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Stmt::Raise &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Stmt::Raise &) const;
  Raise(Term::Any value, ExceptionKind exceptionKind, std::vector<Stmt::Any> cleanup = {}) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT Rethrow : Stmt::Base {
  constexpr static uint32_t variant_id = 12;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Rethrow>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Rethrow modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Rethrow>) {
      return f(*this);
    }
    return Stmt::Rethrow();
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Stmt::Rethrow &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Stmt::Rethrow &) const;
  Rethrow() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Signature {
  ...
  [[nodiscard]] POLYREGION_EXPORT Signature withTpeVars(const std::vector<Type::Var> &v_) const;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Signature modify_all(const std::function<T(const T &)> &f) const {
    ...
    return Signature(name.modify_all<T>(f), tpeVars__, receiver__, args__, moduleCaptures__, termCaptures__, rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const Signature &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Signature &) const;
  Signature(Sym name, std::vector<Type::Var> tpeVars, std::optional<Type::Any> receiver, std::vector<Type::Any> args,
...
struct POLYREGION_EXPORT InvokeSignature {
  ...
  [[nodiscard]] POLYREGION_EXPORT InvokeSignature withTpeArgs(const std::vector<Type::Any> &v_) const;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT InvokeSignature modify_all(const std::function<T(const T &)> &f) const {
    ...
    return InvokeSignature(name.modify_all<T>(f), tpeArgs__, receiver__, args__, rtn.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const InvokeSignature &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const InvokeSignature &) const;
  InvokeSignature(Sym name, std::vector<Type::Any> tpeArgs, std::optional<Type::Any> receiver, std::vector<Type::Any> args,
                  Type::Any rtn) noexcept;
};
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const FunctionAffinity::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const FunctionAffinity::Base &) const = 0;
...
struct POLYREGION_EXPORT Offload : FunctionAffinity::Base {
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Offload>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Offload modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Offload>) {
      return f(*this);
    }
    return FunctionAffinity::Offload();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const FunctionAffinity::Offload &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const FunctionAffinity::Offload &) const;
  Offload() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Host : FunctionAffinity::Base {
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Host modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Host>) {
      return f(*this);
    }
    return FunctionAffinity::Host();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const FunctionAffinity::Host &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const FunctionAffinity::Host &) const;
  Host() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const ArgAccess::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const ArgAccess::Base &) const = 0;
...
struct POLYREGION_EXPORT Read : ArgAccess::Base {
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Read modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Read>) {
      return f(*this);
    }
    return ArgAccess::Read();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgAccess::Read &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgAccess::Read &) const;
  Read() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Write : ArgAccess::Base {
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Write>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Write modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Write>) {
      return f(*this);
    }
    return ArgAccess::Write();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgAccess::Write &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgAccess::Write &) const;
  Write() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT ReadWrite : ArgAccess::Base {
  constexpr static uint32_t variant_id = 2;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ReadWrite>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT ReadWrite modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ReadWrite>) {
      return f(*this);
    }
    return ArgAccess::ReadWrite();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgAccess::ReadWrite &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgAccess::ReadWrite &) const;
  ReadWrite() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const ArgSizeExpr::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const ArgSizeExpr::Base &) const = 0;
...
struct POLYREGION_EXPORT Param : ArgSizeExpr::Base {
  int32_t index;
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT ArgSizeExpr::Param withIndex(const int32_t &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Param modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Param>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgSizeExpr::Param &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgSizeExpr::Param &) const;
  explicit Param(int32_t index) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT Const : ArgSizeExpr::Base {
  int64_t value;
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT ArgSizeExpr::Const withValue(const int64_t &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Const modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Const>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgSizeExpr::Const &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgSizeExpr::Const &) const;
...
struct POLYREGION_EXPORT Add : ArgSizeExpr::Base {
  ArgSizeExpr::Any lhs;
  ArgSizeExpr::Any rhs;
  constexpr static uint32_t variant_id = 2;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT ArgSizeExpr::Add withLhs(const ArgSizeExpr::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT ArgSizeExpr::Add withRhs(const ArgSizeExpr::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Add>) {
      if (auto x_ = f(*this)) {
    ...
    lhs.collect_where<T, U>(results_, f);
    rhs.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
    std::vector<U> results_;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Add modify_all(const std::function<T(const T &)> &f) const {
    ...
    return ArgSizeExpr::Add(lhs.modify_all<T>(f), rhs.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgSizeExpr::Add &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgSizeExpr::Add &) const;
  Add(ArgSizeExpr::Any lhs, ArgSizeExpr::Any rhs) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT Mul : ArgSizeExpr::Base {
  ArgSizeExpr::Any lhs;
  ArgSizeExpr::Any rhs;
  constexpr static uint32_t variant_id = 3;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT ArgSizeExpr::Mul withLhs(const ArgSizeExpr::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT ArgSizeExpr::Mul withRhs(const ArgSizeExpr::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Mul>) {
      if (auto x_ = f(*this)) {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Mul modify_all(const std::function<T(const T &)> &f) const {
    ...
    return ArgSizeExpr::Mul(lhs.modify_all<T>(f), rhs.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgSizeExpr::Mul &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgSizeExpr::Mul &) const;
  Mul(ArgSizeExpr::Any lhs, ArgSizeExpr::Any rhs) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT Min : ArgSizeExpr::Base {
  ArgSizeExpr::Any lhs;
  ArgSizeExpr::Any rhs;
  constexpr static uint32_t variant_id = 4;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT ArgSizeExpr::Min withLhs(const ArgSizeExpr::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT ArgSizeExpr::Min withRhs(const ArgSizeExpr::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Min>) {
      if (auto x_ = f(*this)) {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Min modify_all(const std::function<T(const T &)> &f) const {
    ...
    return ArgSizeExpr::Min(lhs.modify_all<T>(f), rhs.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgSizeExpr::Min &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgSizeExpr::Min &) const;
  Min(ArgSizeExpr::Any lhs, ArgSizeExpr::Any rhs) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace ArgSizeExpr
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const ArgExtent::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const ArgExtent::Base &) const = 0;
...
struct POLYREGION_EXPORT Elements : ArgExtent::Base {
  ArgSizeExpr::Any size;
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT ArgExtent::Elements withSize(const ArgSizeExpr::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Elements modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Elements>) {
      return f(*this);
    }
    return ArgExtent::Elements(size.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgExtent::Elements &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgExtent::Elements &) const;
  explicit Elements(ArgSizeExpr::Any size) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT Bytes : ArgExtent::Base {
  ArgSizeExpr::Any size;
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT ArgExtent::Bytes withSize(const ArgSizeExpr::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Bytes modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Bytes>) {
      return f(*this);
    }
    return ArgExtent::Bytes(size.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgExtent::Bytes &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const ArgExtent::Bytes &) const;
  explicit Bytes(ArgSizeExpr::Any size) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace ArgExtent

struct POLYREGION_EXPORT ArgBoundary {
  ArgAccess::Any access;
  ArgExtent::Any extent;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT ArgBoundary withAccess(const ArgAccess::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT ArgBoundary withExtent(const ArgExtent::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ArgBoundary>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    access.collect_where<T, U>(results_, f);
    extent.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
    std::vector<U> results_;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT ArgBoundary modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ArgBoundary>) {
      return f(*this);
    }
    return ArgBoundary(access.modify_all<T>(f), extent.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const ArgBoundary &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const ArgBoundary &) const;
  ArgBoundary(ArgAccess::Any access, ArgExtent::Any extent) noexcept;
};
...
struct POLYREGION_EXPORT Arg {
  ...
  [[nodiscard]] POLYREGION_EXPORT Arg withBoundary(const std::optional<ArgBoundary> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    ...
    if (boundary) {
      (*boundary).collect_where<T, U>(results_, f);
    }
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Arg modify_all(const std::function<T(const T &)> &f) const {
    ...
    std::optional<ArgBoundary> boundary__;
    if (boundary) {
      boundary__ = (*boundary).modify_all<T>(f);
    }
    return Arg(named.modify_all<T>(f), pos__, boundary__);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const Arg &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Arg &) const;
  Arg(Named named, std::optional<SourcePosition> pos = {}, std::optional<ArgBoundary> boundary = {}) noexcept;
};

struct POLYREGION_EXPORT FunctionDecl {
  Sym name;
  std::vector<Type::Var> tpeVars;
  ...
  Type::Any rtn;
  FunctionAffinity::Any affinity;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT FunctionDecl withName(const Sym &v_) const;
  [[nodiscard]] POLYREGION_EXPORT FunctionDecl withTpeVars(const std::vector<Type::Var> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT FunctionDecl withReceiver(const std::optional<Arg> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT FunctionDecl withArgs(const std::vector<Arg> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT FunctionDecl withModuleCaptures(const std::vector<Arg> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT FunctionDecl withTermCaptures(const std::vector<Arg> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT FunctionDecl withRtn(const Type::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT FunctionDecl withAffinity(const FunctionAffinity::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    ...
    rtn.collect_where<T, U>(results_, f);
    affinity.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
    std::vector<U> results_;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT FunctionDecl modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, FunctionDecl>) {
      return f(*this);
    }
    std::vector<Type::Var> tpeVars__;
    ...
    return FunctionDecl(name.modify_all<T>(f), tpeVars__, receiver__, args__, moduleCaptures__, termCaptures__, rtn.modify_all<T>(f),
                        affinity.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const FunctionDecl &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const FunctionDecl &) const;
  FunctionDecl(Sym name, std::vector<Type::Var> tpeVars, std::optional<Arg> receiver, std::vector<Arg> args,
               std::vector<Arg> moduleCaptures, std::vector<Arg> termCaptures, Type::Any rtn, FunctionAffinity::Any affinity) noexcept;
};
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const CallConvention::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const CallConvention::Base &) const = 0;
...
struct POLYREGION_EXPORT RegularCall : CallConvention::Base {
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RegularCall>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT RegularCall modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, RegularCall>) {
      return f(*this);
    }
    return CallConvention::RegularCall();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const CallConvention::RegularCall &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const CallConvention::RegularCall &) const;
  RegularCall() noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT OffloadEntry : CallConvention::Base {
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, OffloadEntry>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT OffloadEntry modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, OffloadEntry>) {
      return f(*this);
    }
    return CallConvention::OffloadEntry();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const CallConvention::OffloadEntry &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const CallConvention::OffloadEntry &) const;
  OffloadEntry() noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace CallConvention
...
struct POLYREGION_EXPORT Function {
  ...
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT Function withDecl(const FunctionDecl &v_) const;
  ...
  [[nodiscard]] POLYREGION_EXPORT Function withConvention(const CallConvention::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Function withImplements(const std::optional<Sym> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Function withRequiredCapabilities(const std::vector<std::string> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    ...
    decl.collect_where<T, U>(results_, f);
    for (auto it = body.begin(); it != body.end(); ++it) {
      (*it).collect_where<T, U>(results_, f);
    }
    visibility.collect_where<T, U>(results_, f);
    fpMode.collect_where<T, U>(results_, f);
    convention.collect_where<T, U>(results_, f);
    if (implements) {
      (*implements).collect_where<T, U>(results_, f);
    }
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Function modify_all(const std::function<T(const T &)> &f) const {
    ...
    std::optional<Sym> implements__;
    if (implements) {
      implements__ = (*implements).modify_all<T>(f);
    }
    return Function(decl.modify_all<T>(f), body__, visibility.modify_all<T>(f), fpMode.modify_all<T>(f), convention.modify_all<T>(f),
                    implements__, requiredCapabilities);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const Function &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Function &) const;
  Function(FunctionDecl decl, std::vector<Stmt::Any> body, FunctionVisibility::Any visibility, FunctionFpMode::Any fpMode,
...
struct POLYREGION_EXPORT StructDef {
  ...
  [[nodiscard]] POLYREGION_EXPORT StructDef withTpeVars(const std::vector<Type::Var> &v_) const;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT StructDef modify_all(const std::function<T(const T &)> &f) const {
    ...
    return StructDef(name.modify_all<T>(f), tpeVars__, members__, parents__, isUnion);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const StructDef &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const StructDef &) const;
  StructDef(Sym name, std::vector<Type::Var> tpeVars, std::vector<Named> members, std::vector<Type::Struct> parents, bool isUnion) noexcept;
};
...
struct POLYREGION_EXPORT Program {
  ...
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT Program withEntry(const std::optional<Function> &v_) const;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Program modify_all(const std::function<T(const T &)> &f) const {
    ...
    std::optional<Function> entry__;
    if (entry) {
      entry__ = (*entry).modify_all<T>(f);
    }
    std::vector<Function> functions__;
    for (auto it = functions.begin(); it != functions.end(); ++it) {
      functions__.emplace_back((*it).modify_all<T>(f));
    ...
    return Program(entry__, functions__, defs__, phase.modify_all<T>(f), metadata__);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const Program &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Program &) const;
  Program(std::optional<Function> entry, std::vector<Function> functions, std::vector<StructDef> defs, PassPhase::Any phase,
...
struct POLYREGION_EXPORT CompileEvent {
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const CompileEvent &) const;
  CompileEvent(int64_t epochMillis, int64_t elapsedNanos, std::string name, std::string data,
...
struct POLYREGION_EXPORT Interface {
  Sym name;
  std::vector<FunctionDecl> declarations;
  std::vector<MetaEntry> metadata;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT Interface withName(const Sym &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Interface withDeclarations(const std::vector<FunctionDecl> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT Interface withMetadata(const std::vector<MetaEntry> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Interface modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Interface>) {
      return f(*this);
    }
    std::vector<FunctionDecl> declarations__;
    for (auto it = declarations.begin(); it != declarations.end(); ++it) {
      declarations__.emplace_back((*it).modify_all<T>(f));
    }
    std::vector<MetaEntry> metadata__;
    for (auto it = metadata.begin(); it != metadata.end(); ++it) {
      metadata__.emplace_back((*it).modify_all<T>(f));
    }
    return Interface(name.modify_all<T>(f), declarations__, metadata__);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const Interface &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Interface &) const;
  Interface(Sym name, std::vector<FunctionDecl> declarations = {}, std::vector<MetaEntry> metadata = {}) noexcept;
};
...
struct POLYREGION_EXPORT Package {
  ...
  Program program;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT Package withInterface(const Interface &v_) const;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Package modify_all(const std::function<T(const T &)> &f) const {
    ...
    return Package(interface.modify_all<T>(f), program.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const Package &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Package &) const;
  Package(Interface interface, Program program) noexcept;
};

struct POLYREGION_EXPORT PackageTypeSize {
  Type::Any tpe;
  int32_t sizeInBytes;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT PackageTypeSize withTpe(const Type::Any &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageTypeSize withSizeInBytes(const int32_t &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, PackageTypeSize>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT PackageTypeSize modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, PackageTypeSize>) {
      return f(*this);
    }
    return PackageTypeSize(tpe.modify_all<T>(f), sizeInBytes);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const PackageTypeSize &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PackageTypeSize &) const;
  PackageTypeSize(Type::Any tpe, int32_t sizeInBytes) noexcept;
};
...
struct POLYREGION_EXPORT PackageLinkRequest {
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT PackageLinkRequest modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, PackageLinkRequest>) {
      return f(*this);
    }
...
struct POLYREGION_EXPORT PackageSymRequest {
  Package pkg;
  ...
  PackageReturnConvention::Any returnConvention;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymRequest withPkg(const Package &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymRequest withSignature(const InvokeSignature &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymRequest withCallerDecls(const std::vector<FunctionDecl> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymRequest withCallerFns(const std::vector<Function> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymRequest withCallerDefs(const std::vector<StructDef> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymRequest withCapabilities(const std::vector<std::string> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymRequest withTypeSizes(const std::vector<PackageTypeSize> &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymRequest withEntryName(const std::string &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymRequest withReturnConvention(const PackageReturnConvention::Any &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, PackageSymRequest>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
    pkg.collect_where<T, U>(results_, f);
    signature.collect_where<T, U>(results_, f);
    for (auto it = callerDecls.begin(); it != callerDecls.end(); ++it) {
      (*it).collect_where<T, U>(results_, f);
    }
    for (auto it = callerFns.begin(); it != callerFns.end(); ++it) {
      (*it).collect_where<T, U>(results_, f);
    }
    for (auto it = callerDefs.begin(); it != callerDefs.end(); ++it) {
      (*it).collect_where<T, U>(results_, f);
    }
    for (auto it = typeSizes.begin(); it != typeSizes.end(); ++it) {
      (*it).collect_where<T, U>(results_, f);
    }
    returnConvention.collect_where<T, U>(results_, f);
  }
  template <typename T, typename U>
  [[nodiscard]] POLYREGION_EXPORT std::vector<U> collect_where(const std::function<std::optional<U>(const T &)> &f) const {
    std::vector<U> results_;
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT PackageSymRequest modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, PackageSymRequest>) {
      return f(*this);
    }
    std::vector<FunctionDecl> callerDecls__;
    for (auto it = callerDecls.begin(); it != callerDecls.end(); ++it) {
      callerDecls__.emplace_back((*it).modify_all<T>(f));
    }
    std::vector<Function> callerFns__;
    for (auto it = callerFns.begin(); it != callerFns.end(); ++it) {
      callerFns__.emplace_back((*it).modify_all<T>(f));
    }
    std::vector<StructDef> callerDefs__;
    for (auto it = callerDefs.begin(); it != callerDefs.end(); ++it) {
      callerDefs__.emplace_back((*it).modify_all<T>(f));
    }
    std::vector<PackageTypeSize> typeSizes__;
    for (auto it = typeSizes.begin(); it != typeSizes.end(); ++it) {
      typeSizes__.emplace_back((*it).modify_all<T>(f));
    }
    return PackageSymRequest(pkg.modify_all<T>(f), signature.modify_all<T>(f), callerDecls__, callerFns__, callerDefs__, capabilities,
                             typeSizes__, entryName, returnConvention.modify_all<T>(f));
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const PackageSymRequest &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PackageSymRequest &) const;
  PackageSymRequest(Package pkg, InvokeSignature signature, std::vector<FunctionDecl> callerDecls, std::vector<Function> callerFns,
                    std::vector<StructDef> callerDefs, std::vector<std::string> capabilities, std::vector<PackageTypeSize> typeSizes,
                    std::string entryName, PackageReturnConvention::Any returnConvention) noexcept;
};
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const PackageReturnConvention::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const PackageReturnConvention::Base &) const = 0;
...
struct POLYREGION_EXPORT Return : PackageReturnConvention::Base {
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Return modify_all(const std::function<T(const T &)> &f) const {
    ...
    return PackageReturnConvention::Return();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PackageReturnConvention::Return &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const PackageReturnConvention::Return &) const;
  Return() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT OutParam : PackageReturnConvention::Base {
  int32_t index;
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT PackageReturnConvention::OutParam withIndex(const int32_t &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, OutParam>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT OutParam modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, OutParam>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PackageReturnConvention::OutParam &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const PackageReturnConvention::OutParam &) const;
  explicit OutParam(int32_t index) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace PackageReturnConvention
...
struct POLYREGION_EXPORT Base {
  [[nodiscard]] POLYREGION_EXPORT virtual uint32_t id() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual size_t hash_code() const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator==(const PackageEntryArgBinding::Base &) const = 0;
  [[nodiscard]] POLYREGION_EXPORT virtual bool operator<(const PackageEntryArgBinding::Base &) const = 0;
...
struct POLYREGION_EXPORT Context : PackageEntryArgBinding::Base {
  constexpr static uint32_t variant_id = 0;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT Context modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, Context>) {
      return f(*this);
    }
    return PackageEntryArgBinding::Context();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PackageEntryArgBinding::Context &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const PackageEntryArgBinding::Context &) const;
  Context() noexcept;
  POLYREGION_EXPORT operator Any() const;
...
struct POLYREGION_EXPORT CallValue : PackageEntryArgBinding::Base {
  int32_t index;
  constexpr static uint32_t variant_id = 1;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT PackageEntryArgBinding::CallValue withIndex(const int32_t &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, CallValue>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT CallValue modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, CallValue>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PackageEntryArgBinding::CallValue &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const PackageEntryArgBinding::CallValue &) const;
  explicit CallValue(int32_t index) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT CallAddress : PackageEntryArgBinding::Base {
  int32_t index;
  constexpr static uint32_t variant_id = 2;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  [[nodiscard]] POLYREGION_EXPORT PackageEntryArgBinding::CallAddress withIndex(const int32_t &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, CallAddress>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT CallAddress modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, CallAddress>) {
      return f(*this);
    }
  ...
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PackageEntryArgBinding::CallAddress &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const PackageEntryArgBinding::CallAddress &) const;
  explicit CallAddress(int32_t index) noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};

struct POLYREGION_EXPORT ResultAddress : PackageEntryArgBinding::Base {
  constexpr static uint32_t variant_id = 3;
  [[nodiscard]] POLYREGION_EXPORT uint32_t id() const override;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const override;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ResultAddress>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT ResultAddress modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, ResultAddress>) {
      return f(*this);
    }
    return PackageEntryArgBinding::ResultAddress();
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PackageEntryArgBinding::ResultAddress &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const Base &) const override;
  [[nodiscard]] POLYREGION_EXPORT bool operator<(const PackageEntryArgBinding::ResultAddress &) const;
  ResultAddress() noexcept;
  POLYREGION_EXPORT operator Any() const;
  [[nodiscard]] POLYREGION_EXPORT Any widen() const;
};
} // namespace PackageEntryArgBinding

struct POLYREGION_EXPORT PackageSymResolvedProgram {
  Program program;
  std::vector<PackageEntryArgBinding::Any> entryArgs;
  [[nodiscard]] POLYREGION_EXPORT size_t hash_code() const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymResolvedProgram withProgram(const Program &v_) const;
  [[nodiscard]] POLYREGION_EXPORT PackageSymResolvedProgram withEntryArgs(const std::vector<PackageEntryArgBinding::Any> &v_) const;
  template <typename T, typename U>
  POLYREGION_EXPORT void collect_where(std::vector<U> &results_, const std::function<std::optional<U>(const T &)> &f) const {
    if constexpr (std::is_same_v<T, PackageSymResolvedProgram>) {
      if (auto x_ = f(*this)) {
        results_.emplace_back(*x_);
      }
    }
  ...
  template <typename T> [[nodiscard]] POLYREGION_EXPORT PackageSymResolvedProgram modify_all(const std::function<T(const T &)> &f) const {
    if constexpr (std::is_same_v<T, PackageSymResolvedProgram>) {
      return f(*this);
    }
    std::vector<PackageEntryArgBinding::Any> entryArgs__;
    for (auto it = entryArgs.begin(); it != entryArgs.end(); ++it) {
      entryArgs__.emplace_back((*it).modify_all<T>(f));
    }
    return PackageSymResolvedProgram(program.modify_all<T>(f), entryArgs__);
  }
  [[nodiscard]] POLYREGION_EXPORT bool operator!=(const PackageSymResolvedProgram &) const;
  [[nodiscard]] POLYREGION_EXPORT bool operator==(const PackageSymResolvedProgram &) const;
...
using All = alternatives<Global, Local, Private, Constant>;
}
...
using All = alternatives<Field, Deref, Index, IndexDyn>;
}
...
namespace polyregion::polyast::Region {
using All = alternatives<Rooted, Opaque>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::Region::Any::is() const {
  static_assert((polyregion::polyast::Region::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::Region::Any::get() const {
  static_assert((polyregion::polyast::Region::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::Region::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void polyregion::polyast::Region::Any::collect_where(std::vector<U> &results_,
                                                                       const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::Region::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::Region::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::Region::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::Region::Any
polyregion::polyast::Region::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::Region::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::Region::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
using All = alternatives<Alias, SpecOp, MathOp, IntrOp, Cast, Index, RefTo, Alloc, Invoke, ForeignCall, OffsetOf, SizeOf>;
}
...
namespace polyregion::polyast::AtomicOp {
using All = alternatives<Xchg, Add, Sub, And, Or, Xor, Min, Max>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::AtomicOp::Any::is() const {
  static_assert((polyregion::polyast::AtomicOp::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::AtomicOp::Any::get() const {
  static_assert((polyregion::polyast::AtomicOp::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::AtomicOp::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void polyregion::polyast::AtomicOp::Any::collect_where(std::vector<U> &results_,
                                                                         const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::AtomicOp::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::AtomicOp::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::AtomicOp::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::AtomicOp::Any
polyregion::polyast::AtomicOp::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::AtomicOp::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::AtomicOp::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
namespace polyregion::polyast::MemScope {
using All = alternatives<Subgroup, Workgroup, Device, System>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::MemScope::Any::is() const {
  static_assert((polyregion::polyast::MemScope::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::MemScope::Any::get() const {
  static_assert((polyregion::polyast::MemScope::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::MemScope::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void polyregion::polyast::MemScope::Any::collect_where(std::vector<U> &results_,
                                                                         const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::MemScope::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::MemScope::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::MemScope::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::MemScope::Any
polyregion::polyast::MemScope::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::MemScope::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::MemScope::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
namespace polyregion::polyast::MemOrder {
using All = alternatives<Relaxed, Acquire, Release, AcqRel, SeqCst>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::MemOrder::Any::is() const {
  static_assert((polyregion::polyast::MemOrder::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::MemOrder::Any::get() const {
  static_assert((polyregion::polyast::MemOrder::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::MemOrder::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void polyregion::polyast::MemOrder::Any::collect_where(std::vector<U> &results_,
                                                                         const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::MemOrder::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::MemOrder::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::MemOrder::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::MemOrder::Any
polyregion::polyast::MemOrder::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::MemOrder::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::MemOrder::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
namespace polyregion::polyast::Direction {
using All = alternatives<LocalToRemote, RemoteToLocal, RemoteToRemote>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::Direction::Any::is() const {
  static_assert((polyregion::polyast::Direction::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::Direction::Any::get() const {
  static_assert((polyregion::polyast::Direction::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::Direction::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void polyregion::polyast::Direction::Any::collect_where(std::vector<U> &results_,
                                                                          const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::Direction::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::Direction::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::Direction::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::Direction::Any
polyregion::polyast::Direction::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::Direction::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::Direction::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
using All = alternatives<Var, Mut, Update, While, ForRange, Break, Cont, Cond, Return, Annotated, Try, Raise, Rethrow>;
}
...
namespace polyregion::polyast::FunctionAffinity {
using All = alternatives<Offload, Host>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::FunctionAffinity::Any::is() const {
  static_assert((polyregion::polyast::FunctionAffinity::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::FunctionAffinity::Any::get() const {
  static_assert((polyregion::polyast::FunctionAffinity::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::FunctionAffinity::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void
polyregion::polyast::FunctionAffinity::Any::collect_where(std::vector<U> &results_,
                                                          const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::FunctionAffinity::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::FunctionAffinity::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::FunctionAffinity::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::FunctionAffinity::Any
polyregion::polyast::FunctionAffinity::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::FunctionAffinity::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::FunctionAffinity::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
namespace polyregion::polyast::ArgAccess {
using All = alternatives<Read, Write, ReadWrite>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::ArgAccess::Any::is() const {
  static_assert((polyregion::polyast::ArgAccess::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::ArgAccess::Any::get() const {
  static_assert((polyregion::polyast::ArgAccess::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::ArgAccess::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void polyregion::polyast::ArgAccess::Any::collect_where(std::vector<U> &results_,
                                                                          const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::ArgAccess::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::ArgAccess::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::ArgAccess::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::ArgAccess::Any
polyregion::polyast::ArgAccess::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::ArgAccess::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::ArgAccess::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
namespace polyregion::polyast::ArgSizeExpr {
using All = alternatives<Param, Const, Add, Mul, Min>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::ArgSizeExpr::Any::is() const {
  static_assert((polyregion::polyast::ArgSizeExpr::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::ArgSizeExpr::Any::get() const {
  static_assert((polyregion::polyast::ArgSizeExpr::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::ArgSizeExpr::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void polyregion::polyast::ArgSizeExpr::Any::collect_where(std::vector<U> &results_,
                                                                            const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::ArgSizeExpr::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::ArgSizeExpr::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::ArgSizeExpr::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::ArgSizeExpr::Any
polyregion::polyast::ArgSizeExpr::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::ArgSizeExpr::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::ArgSizeExpr::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
namespace polyregion::polyast::ArgExtent {
using All = alternatives<Elements, Bytes>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::ArgExtent::Any::is() const {
  static_assert((polyregion::polyast::ArgExtent::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::ArgExtent::Any::get() const {
  static_assert((polyregion::polyast::ArgExtent::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::ArgExtent::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void polyregion::polyast::ArgExtent::Any::collect_where(std::vector<U> &results_,
                                                                          const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::ArgExtent::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::ArgExtent::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::ArgExtent::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::ArgExtent::Any
polyregion::polyast::ArgExtent::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::ArgExtent::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::ArgExtent::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
namespace polyregion::polyast::CallConvention {
using All = alternatives<RegularCall, OffloadEntry>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::CallConvention::Any::is() const {
  static_assert((polyregion::polyast::CallConvention::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::CallConvention::Any::get() const {
  static_assert((polyregion::polyast::CallConvention::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::CallConvention::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void polyregion::polyast::CallConvention::Any::collect_where(std::vector<U> &results_,
                                                                               const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::CallConvention::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::CallConvention::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::CallConvention::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::CallConvention::Any
polyregion::polyast::CallConvention::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::CallConvention::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::CallConvention::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
namespace polyregion::polyast::PackageReturnConvention {
using All = alternatives<Return, OutParam>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::PackageReturnConvention::Any::is() const {
  static_assert((polyregion::polyast::PackageReturnConvention::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::PackageReturnConvention::Any::get() const {
  static_assert((polyregion::polyast::PackageReturnConvention::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs>
constexpr POLYREGION_EXPORT auto polyregion::polyast::PackageReturnConvention::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void
polyregion::polyast::PackageReturnConvention::Any::collect_where(std::vector<U> &results_,
                                                                 const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::PackageReturnConvention::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::PackageReturnConvention::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::PackageReturnConvention::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::PackageReturnConvention::Any
polyregion::polyast::PackageReturnConvention::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::PackageReturnConvention::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::PackageReturnConvention::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
namespace polyregion::polyast::PackageEntryArgBinding {
using All = alternatives<Context, CallValue, CallAddress, ResultAddress>;
}
template <typename T> constexpr POLYREGION_EXPORT bool polyregion::polyast::PackageEntryArgBinding::Any::is() const {
  static_assert((polyregion::polyast::PackageEntryArgBinding::All::contains<T>), "type not part of the variant");
  return T::variant_id == _v->id();
}
template <typename T> constexpr POLYREGION_EXPORT std::optional<T> polyregion::polyast::PackageEntryArgBinding::Any::get() const {
  static_assert((polyregion::polyast::PackageEntryArgBinding::All::contains<T>), "type not part of the variant");
  if (T::variant_id == _v->id()) return {*std::static_pointer_cast<T>(_v)};
  else return {};
}
template <typename... Fs> constexpr POLYREGION_EXPORT auto polyregion::polyast::PackageEntryArgBinding::Any::match_total(Fs &&...fs) const {
  using Ts = alternatives<std::decay_t<arg1_t<Fs>>...>;
  using Rs = alternatives<std::invoke_result_t<Fs, std::decay_t<arg1_t<Fs>>>...>;
  using R0 = typename Rs::template at<0>;
  static_assert(All::size == sizeof...(Fs), "match is not total as case count is not equal to variant's size");
...
template <typename T, typename U>
POLYREGION_EXPORT void
polyregion::polyast::PackageEntryArgBinding::Any::collect_where(std::vector<U> &results_,
                                                                const std::function<std::optional<U>(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::PackageEntryArgBinding::Any>) {
    if (auto x_ = f(_v)) {
      results_.emplace_back(*x_);
    }
    return;
...
template <typename T, typename U>
POLYREGION_EXPORT std::vector<U>
polyregion::polyast::PackageEntryArgBinding::Any::collect_where(const std::function<std::optional<U>(const T &)> &f) const {
  std::vector<U> results_;
  collect_where<T, U>(results_, f);
  return results_;
}
template <typename T> POLYREGION_EXPORT std::vector<T> polyregion::polyast::PackageEntryArgBinding::Any::collect_all() const {
  return collect_where<T, T>([](auto &x) { return std::optional<T>{x}; });
}
template <typename T>
POLYREGION_EXPORT polyregion::polyast::PackageEntryArgBinding::Any
polyregion::polyast::PackageEntryArgBinding::Any::modify_all(const std::function<T(const T &)> &f) const {
  if constexpr (std::is_same_v<T, polyregion::polyast::PackageEntryArgBinding::Any>) {
    return f(*this);
  }
  std::optional<polyregion::polyast::PackageEntryArgBinding::Any> result_;
  All::applyOr([&, id = _v->id()]<typename V>() -> bool {
    if (V::variant_id != id) return false;
    auto _x = std::static_pointer_cast<V>(_v);
    result_ = _x->template modify_all<T>(f).widen();
...
template <> struct hash<polyregion::polyast::Origin> {
  std::size_t operator()(const polyregion::polyast::Origin &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::TypeSpace::Constant> {
  std::size_t operator()(const polyregion::polyast::TypeSpace::Constant &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::Type::FnRef> {
  std::size_t operator()(const polyregion::polyast::Type::FnRef &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::PathStep::Index> {
  std::size_t operator()(const polyregion::polyast::PathStep::Index &) const noexcept;
};
template <> struct hash<polyregion::polyast::PathStep::IndexDyn> {
  std::size_t operator()(const polyregion::polyast::PathStep::IndexDyn &) const noexcept;
};
template <> struct hash<polyregion::polyast::Region::Any> {
  std::size_t operator()(const polyregion::polyast::Region::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::Region::Rooted> {
  std::size_t operator()(const polyregion::polyast::Region::Rooted &) const noexcept;
};
template <> struct hash<polyregion::polyast::Region::Opaque> {
  std::size_t operator()(const polyregion::polyast::Region::Opaque &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::Expr::ForeignCall> {
  std::size_t operator()(const polyregion::polyast::Expr::ForeignCall &) const noexcept;
};
template <> struct hash<polyregion::polyast::Expr::OffsetOf> {
  std::size_t operator()(const polyregion::polyast::Expr::OffsetOf &) const noexcept;
};
template <> struct hash<polyregion::polyast::Expr::SizeOf> {
  std::size_t operator()(const polyregion::polyast::Expr::SizeOf &) const noexcept;
};
template <> struct hash<polyregion::polyast::Overload> {
  std::size_t operator()(const polyregion::polyast::Overload &) const noexcept;
};
template <> struct hash<polyregion::polyast::AtomicOp::Any> {
  std::size_t operator()(const polyregion::polyast::AtomicOp::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::AtomicOp::Xchg> {
  std::size_t operator()(const polyregion::polyast::AtomicOp::Xchg &) const noexcept;
};
template <> struct hash<polyregion::polyast::AtomicOp::Add> {
  std::size_t operator()(const polyregion::polyast::AtomicOp::Add &) const noexcept;
};
template <> struct hash<polyregion::polyast::AtomicOp::Sub> {
  std::size_t operator()(const polyregion::polyast::AtomicOp::Sub &) const noexcept;
};
template <> struct hash<polyregion::polyast::AtomicOp::And> {
  std::size_t operator()(const polyregion::polyast::AtomicOp::And &) const noexcept;
};
template <> struct hash<polyregion::polyast::AtomicOp::Or> {
  std::size_t operator()(const polyregion::polyast::AtomicOp::Or &) const noexcept;
};
template <> struct hash<polyregion::polyast::AtomicOp::Xor> {
  std::size_t operator()(const polyregion::polyast::AtomicOp::Xor &) const noexcept;
};
template <> struct hash<polyregion::polyast::AtomicOp::Min> {
  std::size_t operator()(const polyregion::polyast::AtomicOp::Min &) const noexcept;
};
template <> struct hash<polyregion::polyast::AtomicOp::Max> {
  std::size_t operator()(const polyregion::polyast::AtomicOp::Max &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemScope::Any> {
  std::size_t operator()(const polyregion::polyast::MemScope::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemScope::Subgroup> {
  std::size_t operator()(const polyregion::polyast::MemScope::Subgroup &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemScope::Workgroup> {
  std::size_t operator()(const polyregion::polyast::MemScope::Workgroup &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemScope::Device> {
  std::size_t operator()(const polyregion::polyast::MemScope::Device &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemScope::System> {
  std::size_t operator()(const polyregion::polyast::MemScope::System &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemOrder::Any> {
  std::size_t operator()(const polyregion::polyast::MemOrder::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemOrder::Relaxed> {
  std::size_t operator()(const polyregion::polyast::MemOrder::Relaxed &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemOrder::Acquire> {
  std::size_t operator()(const polyregion::polyast::MemOrder::Acquire &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemOrder::Release> {
  std::size_t operator()(const polyregion::polyast::MemOrder::Release &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemOrder::AcqRel> {
  std::size_t operator()(const polyregion::polyast::MemOrder::AcqRel &) const noexcept;
};
template <> struct hash<polyregion::polyast::MemOrder::SeqCst> {
  std::size_t operator()(const polyregion::polyast::MemOrder::SeqCst &) const noexcept;
};
template <> struct hash<polyregion::polyast::Direction::Any> {
  std::size_t operator()(const polyregion::polyast::Direction::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::Direction::LocalToRemote> {
  std::size_t operator()(const polyregion::polyast::Direction::LocalToRemote &) const noexcept;
};
template <> struct hash<polyregion::polyast::Direction::RemoteToLocal> {
  std::size_t operator()(const polyregion::polyast::Direction::RemoteToLocal &) const noexcept;
};
template <> struct hash<polyregion::polyast::Direction::RemoteToRemote> {
  std::size_t operator()(const polyregion::polyast::Direction::RemoteToRemote &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::Spec::GpuAtomicRMW> {
  std::size_t operator()(const polyregion::polyast::Spec::GpuAtomicRMW &) const noexcept;
};
template <> struct hash<polyregion::polyast::Spec::GpuAtomicCAS> {
  std::size_t operator()(const polyregion::polyast::Spec::GpuAtomicCAS &) const noexcept;
};
template <> struct hash<polyregion::polyast::Spec::GpuGroupReduce> {
  std::size_t operator()(const polyregion::polyast::Spec::GpuGroupReduce &) const noexcept;
};
template <> struct hash<polyregion::polyast::Spec::GpuGroupInclusiveScan> {
  std::size_t operator()(const polyregion::polyast::Spec::GpuGroupInclusiveScan &) const noexcept;
};
template <> struct hash<polyregion::polyast::Spec::GpuGroupExclusiveScan> {
  std::size_t operator()(const polyregion::polyast::Spec::GpuGroupExclusiveScan &) const noexcept;
};
template <> struct hash<polyregion::polyast::Spec::GpuVolatileLoad> {
  std::size_t operator()(const polyregion::polyast::Spec::GpuVolatileLoad &) const noexcept;
};
template <> struct hash<polyregion::polyast::Spec::GpuVolatileStore> {
  std::size_t operator()(const polyregion::polyast::Spec::GpuVolatileStore &) const noexcept;
};
template <> struct hash<polyregion::polyast::Spec::RemoteLaunch> {
  std::size_t operator()(const polyregion::polyast::Spec::RemoteLaunch &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::Spec::RemoteMemcpy> {
  std::size_t operator()(const polyregion::polyast::Spec::RemoteMemcpy &) const noexcept;
};
template <> struct hash<polyregion::polyast::Spec::RemoteSync> {
  std::size_t operator()(const polyregion::polyast::Spec::RemoteSync &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::ExceptionKind> {
  std::size_t operator()(const polyregion::polyast::ExceptionKind &) const noexcept;
};
template <> struct hash<polyregion::polyast::Handler> {
  std::size_t operator()(const polyregion::polyast::Handler &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::Stmt::Try> {
  std::size_t operator()(const polyregion::polyast::Stmt::Try &) const noexcept;
};
template <> struct hash<polyregion::polyast::Stmt::Raise> {
  std::size_t operator()(const polyregion::polyast::Stmt::Raise &) const noexcept;
};
template <> struct hash<polyregion::polyast::Stmt::Rethrow> {
  std::size_t operator()(const polyregion::polyast::Stmt::Rethrow &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::FunctionAffinity::Any> {
  std::size_t operator()(const polyregion::polyast::FunctionAffinity::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::FunctionAffinity::Offload> {
  std::size_t operator()(const polyregion::polyast::FunctionAffinity::Offload &) const noexcept;
};
template <> struct hash<polyregion::polyast::FunctionAffinity::Host> {
  std::size_t operator()(const polyregion::polyast::FunctionAffinity::Host &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgAccess::Any> {
  std::size_t operator()(const polyregion::polyast::ArgAccess::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgAccess::Read> {
  std::size_t operator()(const polyregion::polyast::ArgAccess::Read &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgAccess::Write> {
  std::size_t operator()(const polyregion::polyast::ArgAccess::Write &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgAccess::ReadWrite> {
  std::size_t operator()(const polyregion::polyast::ArgAccess::ReadWrite &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgSizeExpr::Any> {
  std::size_t operator()(const polyregion::polyast::ArgSizeExpr::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgSizeExpr::Param> {
  std::size_t operator()(const polyregion::polyast::ArgSizeExpr::Param &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgSizeExpr::Const> {
  std::size_t operator()(const polyregion::polyast::ArgSizeExpr::Const &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgSizeExpr::Add> {
  std::size_t operator()(const polyregion::polyast::ArgSizeExpr::Add &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgSizeExpr::Mul> {
  std::size_t operator()(const polyregion::polyast::ArgSizeExpr::Mul &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgSizeExpr::Min> {
  std::size_t operator()(const polyregion::polyast::ArgSizeExpr::Min &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgExtent::Any> {
  std::size_t operator()(const polyregion::polyast::ArgExtent::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgExtent::Elements> {
  std::size_t operator()(const polyregion::polyast::ArgExtent::Elements &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgExtent::Bytes> {
  std::size_t operator()(const polyregion::polyast::ArgExtent::Bytes &) const noexcept;
};
template <> struct hash<polyregion::polyast::ArgBoundary> {
  std::size_t operator()(const polyregion::polyast::ArgBoundary &) const noexcept;
};
template <> struct hash<polyregion::polyast::Arg> {
  std::size_t operator()(const polyregion::polyast::Arg &) const noexcept;
};
template <> struct hash<polyregion::polyast::FunctionDecl> {
  std::size_t operator()(const polyregion::polyast::FunctionDecl &) const noexcept;
};
template <> struct hash<polyregion::polyast::CallConvention::Any> {
  std::size_t operator()(const polyregion::polyast::CallConvention::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::CallConvention::RegularCall> {
  std::size_t operator()(const polyregion::polyast::CallConvention::RegularCall &) const noexcept;
};
template <> struct hash<polyregion::polyast::CallConvention::OffloadEntry> {
  std::size_t operator()(const polyregion::polyast::CallConvention::OffloadEntry &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::Interface> {
  std::size_t operator()(const polyregion::polyast::Interface &) const noexcept;
};
template <> struct hash<polyregion::polyast::Package> {
  std::size_t operator()(const polyregion::polyast::Package &) const noexcept;
};
template <> struct hash<polyregion::polyast::PackageTypeSize> {
  std::size_t operator()(const polyregion::polyast::PackageTypeSize &) const noexcept;
};
...
template <> struct hash<polyregion::polyast::PackageSymRequest> {
  std::size_t operator()(const polyregion::polyast::PackageSymRequest &) const noexcept;
};
template <> struct hash<polyregion::polyast::PackageReturnConvention::Any> {
  std::size_t operator()(const polyregion::polyast::PackageReturnConvention::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::PackageReturnConvention::Return> {
  std::size_t operator()(const polyregion::polyast::PackageReturnConvention::Return &) const noexcept;
};
template <> struct hash<polyregion::polyast::PackageReturnConvention::OutParam> {
  std::size_t operator()(const polyregion::polyast::PackageReturnConvention::OutParam &) const noexcept;
};
template <> struct hash<polyregion::polyast::PackageEntryArgBinding::Any> {
  std::size_t operator()(const polyregion::polyast::PackageEntryArgBinding::Any &) const noexcept;
};
template <> struct hash<polyregion::polyast::PackageEntryArgBinding::Context> {
  std::size_t operator()(const polyregion::polyast::PackageEntryArgBinding::Context &) const noexcept;
};
template <> struct hash<polyregion::polyast::PackageEntryArgBinding::CallValue> {
  std::size_t operator()(const polyregion::polyast::PackageEntryArgBinding::CallValue &) const noexcept;
};
template <> struct hash<polyregion::polyast::PackageEntryArgBinding::CallAddress> {
  std::size_t operator()(const polyregion::polyast::PackageEntryArgBinding::CallAddress &) const noexcept;
};
template <> struct hash<polyregion::polyast::PackageEntryArgBinding::ResultAddress> {
  std::size_t operator()(const polyregion::polyast::PackageEntryArgBinding::ResultAddress &) const noexcept;
};
