...
PathStep::Deref PathStep::deref_from_json(const json& j_) { 
  return {};
}

json PathStep::deref_to_json(const PathStep::Deref& x_) { 
  return json::array({});
}
...
json PathStep::any_to_json(const PathStep::Any& x_) { 
  return x_.match_total(
  [](const PathStep::Field &y_) -> json { return {0, PathStep::field_to_json(y_)}; }
  ,
...
Term::Select Term::select_from_json(const json& j_) { 
  ...
  for(const auto &v_ : j_.at(1)) { steps.emplace_back(PathStep::any_from_json(v_)); }
...
json Term::select_to_json(const Term::Select& x_) { 
  ...
  for(const auto &v_ : x_.steps) { steps.emplace_back(PathStep::any_to_json(v_)); }
  auto tpe = Type::any_to_json(x_.tpe);
...
json Term::any_to_json(const Term::Any& x_) { 
  return x_.match_total(
  [](const Term::Float16Const &y_) -> json { return {0, Term::float16const_to_json(y_)}; }
  ,
...
Expr::Invoke Expr::invoke_from_json(const json& j_) { 
  ...
  for(const auto &v_ : j_.at(3)) { args.emplace_back(Term::any_from_json(v_)); }
...
json Expr::invoke_to_json(const Expr::Invoke& x_) { 
  ...
  std::vector<json> args;
  for(const auto &v_ : x_.args) { args.emplace_back(Term::any_to_json(v_)); }
  auto rtn = Type::any_to_json(x_.rtn);
...
json Expr::any_to_json(const Expr::Any& x_) { 
  return x_.match_total(
  [](const Expr::Alias &y_) -> json { return {0, Expr::alias_to_json(y_)}; }
  ,
...
Stmt::While Stmt::while_from_json(const json& j_) { 
  ...
  for(const auto &v_ : j_.at(1)) { body.emplace_back(Stmt::any_from_json(v_)); }
  return {cond, body};
}
...
json Stmt::any_to_json(const Stmt::Any& x_) { 
  return x_.match_total(
  [](const Stmt::Var &y_) -> json { return {0, Stmt::var_to_json(y_)}; }
  ,
...
FunctionVisibility::Internal FunctionVisibility::internal_from_json(const json& j_) { 
  return {};
}

json FunctionVisibility::internal_to_json(const FunctionVisibility::Internal& x_) { 
  return json::array({});
}

FunctionVisibility::Exported FunctionVisibility::exported_from_json(const json& j_) { 
  return {};
}

json FunctionVisibility::exported_to_json(const FunctionVisibility::Exported& x_) { 
  return json::array({});
}
...
json FunctionVisibility::any_to_json(const FunctionVisibility::Any& x_) { 
  return x_.match_total(
  [](const FunctionVisibility::Internal &y_) -> json { return {0, FunctionVisibility::internal_to_json(y_)}; }
  ,
  [](const FunctionVisibility::Exported &y_) -> json { return {1, FunctionVisibility::exported_to_json(y_)}; }
  );
}

FunctionFpMode::Relaxed FunctionFpMode::relaxed_from_json(const json& j_) { 
  return {};
}

json FunctionFpMode::relaxed_to_json(const FunctionFpMode::Relaxed& x_) { 
  return json::array({});
}

FunctionFpMode::Strict FunctionFpMode::strict_from_json(const json& j_) { 
  return {};
}

json FunctionFpMode::strict_to_json(const FunctionFpMode::Strict& x_) { 
  return json::array({});
}
...
json FunctionFpMode::any_to_json(const FunctionFpMode::Any& x_) { 
  return x_.match_total(
  [](const FunctionFpMode::Relaxed &y_) -> json { return {0, FunctionFpMode::relaxed_to_json(y_)}; }
  ,
...
StructDef structdef_from_json(const json& j_) { 
  ...
  for(const auto &v_ : j_.at(3)) { parents.emplace_back(Type::struct_from_json(v_)); }
...
json structdef_to_json(const StructDef& x_) { 
  ...
  for(const auto &v_ : x_.parents) { parents.emplace_back(Type::struct_to_json(v_)); }
...
PassPhase::Initial PassPhase::initial_from_json(const json& j_) { 
  return {};
}

json PassPhase::initial_to_json(const PassPhase::Initial& x_) { 
  return json::array({});
}

PassPhase::PostMono PassPhase::postmono_from_json(const json& j_) { 
  return {};
}

json PassPhase::postmono_to_json(const PassPhase::PostMono& x_) { 
  return json::array({});
}
...
json PassPhase::any_to_json(const PassPhase::Any& x_) { 
  return x_.match_total(
  [](const PassPhase::Initial &y_) -> json { return {0, PassPhase::initial_to_json(y_)}; }
  ,
...
json hashed_to_json(const json& x_) { 
  return json::array({"5ef323cbe7e50326aaf864ddbfce3efd", x_});
}
} // namespace polyregion::polyast
