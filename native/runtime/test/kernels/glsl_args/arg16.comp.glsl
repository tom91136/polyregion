...
struct Args { float a, b, c, d, e, f, g, h, i, j, k, l, m, n, o; };
...
void main() {
    out_[0] = args.a + args.b + args.c + args.d + args.e + args.f + args.g + args.h + args.i + args.j + args.k + args.l + args.m + args.n + args.o;
}
