...
inline std::string deviceArena() { return "FullOpt;StructuredExit;ArenaLower;VerifyAnchors(strict=true)"; }
...
inline std::string deviceArenaLogical() { return "FullOpt;StructuredExit;Anchor;ArenaView;RegionRespace;VerifyAnchors(strict=true)"; }
