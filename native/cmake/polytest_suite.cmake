function(polytest_configure_suite target)
    ...
    if (ARG_RECURSIVE)
        file(GLOB _top "${CMAKE_CURRENT_SOURCE_DIR}/test/${ARG_GLOB}")
        file(GLOB _sub "${CMAKE_CURRENT_SOURCE_DIR}/test/**/${ARG_GLOB}")
        set(_paths ${_top} ${_sub})
    else ()
        file(GLOB _paths "${CMAKE_CURRENT_SOURCE_DIR}/test/${ARG_GLOB}")
    endif ()
