...
set(CMAKE_TOOLCHAIN_FILE "${CMAKE_SOURCE_DIR}/toolchain_${CMAKE_HOST_SYSTEM_NAME}_${COMPILER_NAME}_${ARCH}.cmake")
...
if (CMAKE_TOOLCHAIN_FILE)
    list(APPEND BUILD_OPTIONS -DCMAKE_TOOLCHAIN_FILE=${VCPKG_ROOT}/scripts/buildsystems/vcpkg.cmake -DVCPKG_CHAINLOAD_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE})
else ()
...
elseif ("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "dawrin")
...
if (NOT VCPKG_TARGET_TRIPLET)
    message(FATAL_ERROR "VCPKG_TARGET_TRIPLET not set, unknown system ${CMAKE_HOST_SYSTEM_NAME} and arch ${ARCH} ")
else ()
