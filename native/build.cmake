...
string(TOLOWER "out/build-${CMAKE_HOST_SYSTEM_NAME}-${ARCH}-${LLVM_VARIANT}" BUILD_NAME)
set(LLVM_BUILD_DIR "${CMAKE_CURRENT_SOURCE_DIR}/out/llvm-${CMAKE_BUILD_TYPE}-${ARCH}-${LLVM_VARIANT}")
set(LLVM_DIST_DIR "${CMAKE_CURRENT_SOURCE_DIR}/out/polyregion-${CMAKE_BUILD_TYPE}-${ARCH}-${LLVM_VARIANT}-dist")
...
elseif (ACTION STREQUAL "DIST_TEST")
    setup_vcpkg()
    set(TEST_DIST_DIR "${CMAKE_CURRENT_SOURCE_DIR}/out/polyregion-test-${CMAKE_BUILD_TYPE}-${ARCH}-${LLVM_VARIANT}-dist")
