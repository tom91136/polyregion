...
//    std::cout << "[" <<   expectedToOptional(section.getName())->str() << "]\n";
//    if (!section.isText()) continue;
//    auto content = expectedToErrorOr(section.getContents()).get();
//
//    cs_insn *insn;
...
//        };
//      }
//      sections.push_back(polyregion::dis::AsmSection{section.getAddress(), expectedToOptional(section.getName())->str(), instructions});
//      cs_free(insn, count);
//    } else {
