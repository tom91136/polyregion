...
[[nodiscard]] EXPORT Expr::Mod mod_from_json(const json &);
[[nodiscard]] EXPORT json mod_to_json(const Expr::Mod &);
[[nodiscard]] EXPORT Expr::Pow pow_from_json(const json &);
[[nodiscard]] EXPORT json pow_to_json(const Expr::Pow &);
[[nodiscard]] EXPORT Expr::Inv inv_from_json(const json &);
[[nodiscard]] EXPORT json inv_to_json(const Expr::Inv &);
